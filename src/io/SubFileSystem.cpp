...
tc::io::SubFileSystem::SubFileSystem() : mBaseFileSystem(), mBasePathResolver(), mSubPathResolver() {}

tc::io::SubFileSystem::SubFileSystem(
    const std::shared_ptr<tc::io::IFileSystem> &file_system, const tc::io::Path &base_path)
    : SubFileSystem()
{
...
void tc::io::SubFileSystem::createFile(const tc::io::Path &path)
{
    if (this->state().test(RESFLAG_READY) == false)
    {
        throw tc::ObjectDisposedException(
            kClassName + "::createFile()", "Failed to create file (file system was not ready)");
    }
...
void tc::io::SubFileSystem::removeFile(const tc::io::Path &path)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::removeFile()", "Failed to remove file (file system was not ready)");
    }
...
void tc::io::SubFileSystem::openFile(
    ...
    std::shared_ptr<tc::io::IStream> &stream)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::openFile()", "Failed to open file (file system was not ready)");
    }
...
void tc::io::SubFileSystem::createDirectory(const tc::io::Path &path)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::createDirectory()", "Failed to create directory (file system was not ready)");
    }
...
void tc::io::SubFileSystem::createDirectoryPath(const tc::io::Path &path)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::createDirectoryPath()", "Failed to create directory path (file system was not ready)");
    }
...
void tc::io::SubFileSystem::removeDirectory(const tc::io::Path &path)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::removeDirectory()", "Failed to remove directory (file system was not ready)");
    }
...
void tc::io::SubFileSystem::getCanonicalPath(const tc::io::Path &path, tc::io::Path &canon_path)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::getCanonicalPath()", "Failed to get absolute path (file system was not ready)");
    }
...
void tc::io::SubFileSystem::getWorkingDirectory(tc::io::Path &path)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::getWorkingDirectory()",
            "Failed to get current working directory (file system was not ready)");
    }
...
void tc::io::SubFileSystem::setWorkingDirectory(const tc::io::Path &path)
{
    if (this->state().test(RESFLAG_READY) == false)
    {
        throw tc::ObjectDisposedException(
            ...
            "Failed to set current working directory (file system was not ready)");
    }
...
void tc::io::SubFileSystem::getDirectoryListing(const tc::io::Path &path, sDirectoryListing &info)
{
    ...
    {
        throw tc::ObjectDisposedException(
            kClassName + "::getDirectoryListing()", "Failed to get directory listing (file system was not ready)");
    }
