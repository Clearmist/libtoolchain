...
bool tc::crypto::EncryptRsa1024OaepSha2256(
    byte_t *block,
...
bool tc::crypto::DecryptRsa1024OaepSha2256(
    byte_t *message,
    size_t &message_size,
...
bool tc::crypto::EncryptRsa2048OaepSha2256(
    byte_t *block,
    const byte_t *message,
    size_t message_size,
    const RsaKey &key,
...
bool tc::crypto::DecryptRsa2048OaepSha2256(
    byte_t *message,
    size_t &message_size,
    size_t message_capacity,
    const byte_t *block,
...
bool tc::crypto::EncryptRsa4096OaepSha2256(
    byte_t *block,
    const byte_t *message,
    size_t message_size,
    const RsaKey &key,
...
bool tc::crypto::DecryptRsa4096OaepSha2256(
    byte_t *message,
    size_t &message_size,
    size_t message_capacity,
    const byte_t *block,
