...
tc::crypto::detail::DesImpl::DesImpl() : mState(State::None), mImplCtx(new ImplCtx())
{
...
void tc::crypto::detail::DesImpl::initialize(const byte_t *key, size_t key_size)
{
    if (key == nullptr)
    {
        throw tc::ArgumentNullException("DesImpl::initialize()", "key was null.");
    }
    if (key_size != 8)
    {
        throw tc::ArgumentOutOfRangeException("DesImpl::initialize()", "key_size did not equal 8.");
    }
...
void tc::crypto::detail::DesImpl::encrypt(byte_t *dst, const byte_t *src)
{
    ...
    if (dst == nullptr)
    {
        throw tc::ArgumentNullException("DesImpl::encrypt()", "dst was null.");
    }
    if (src == nullptr)
    {
        throw tc::ArgumentNullException("DesImpl::encrypt()", "src was null.");
    }
...
void tc::crypto::detail::DesImpl::decrypt(byte_t *dst, const byte_t *src)
{
    ...
    if (dst == nullptr)
    {
        throw tc::ArgumentNullException("DesImpl::decrypt()", "dst was null.");
    }
    if (src == nullptr)
    {
        throw tc::ArgumentNullException("DesImpl::decrypt()", "src was null.");
    }
