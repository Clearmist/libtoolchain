...
tc::crypto::detail::AesImpl::AesImpl() : mState(State::None), mImplCtx(new ImplCtx())
{
...
void tc::crypto::detail::AesImpl::initialize(const byte_t *key, size_t key_size)
{
    if (key == nullptr)
    {
        throw tc::ArgumentNullException("AesImpl::initialize()", "key was null.");
    }
    if (key_size != 16 && key_size != 24 && key_size != 32)
    {
        throw tc::ArgumentOutOfRangeException("AesImpl::initialize()", "key_size did not equal 16, 24 or 32.");
    }
...
void tc::crypto::detail::AesImpl::encrypt(byte_t *dst, const byte_t *src)
{
    ...
    if (dst == nullptr)
    {
        throw tc::ArgumentNullException("AesImpl::encrypt()", "dst was null.");
    }
    if (src == nullptr)
    {
        throw tc::ArgumentNullException("AesImpl::encrypt()", "src was null.");
    }
...
void tc::crypto::detail::AesImpl::decrypt(byte_t *dst, const byte_t *src)
{
    ...
    if (dst == nullptr)
    {
        throw tc::ArgumentNullException("AesImpl::decrypt()", "dst was null.");
    }
    if (src == nullptr)
    {
        throw tc::ArgumentNullException("AesImpl::decrypt()", "src was null.");
    }
