...
tc::crypto::detail::TdesImpl::TdesImpl() : mState(State::None), mImplCtx(new ImplCtx())
{
...
void tc::crypto::detail::TdesImpl::initialize(const byte_t *key, size_t key_size)
{
    if (key == nullptr)
    {
        throw tc::ArgumentNullException("TdesImpl::initialize()", "key was null.");
    }
    if (key_size != 16 && key_size != 24)
    {
        throw tc::ArgumentOutOfRangeException("TdesImpl::initialize()", "key_size did not equal 16 or 24.");
    }
...
void tc::crypto::detail::TdesImpl::encrypt(byte_t *dst, const byte_t *src)
{
    ...
    if (dst == nullptr)
    {
        throw tc::ArgumentNullException("TdesImpl::encrypt()", "dst was null.");
    }
    if (src == nullptr)
    {
        throw tc::ArgumentNullException("TdesImpl::encrypt()", "src was null.");
    }
...
void tc::crypto::detail::TdesImpl::decrypt(byte_t *dst, const byte_t *src)
{
    ...
    if (dst == nullptr)
    {
        throw tc::ArgumentNullException("TdesImpl::decrypt()", "dst was null.");
    }
    if (src == nullptr)
    {
        throw tc::ArgumentNullException("TdesImpl::decrypt()", "src was null.");
    }
