...
tc::ByteData::ByteData() : ByteData(0) {}

tc::ByteData::ByteData(const tc::ByteData &other) : ByteData(other.mPtr.get(), other.mSize) {}

tc::ByteData::ByteData(tc::ByteData &&other) : mSize(other.mSize), mPtr(std::move(other.mPtr))
{
    other.mSize = 0;
}

tc::ByteData::ByteData(std::initializer_list<byte_t> l) : ByteData(l.size(), false)
{
    size_t i = 0;
...
tc::ByteData::ByteData(const byte_t *data, size_t size) : ByteData(size, false)
{
