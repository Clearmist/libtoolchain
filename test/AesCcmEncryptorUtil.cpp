...
void AesCcmEncryptorUtil::generateAesCcmTestVectors_Nist(
    std::vector<AesCcmEncryptorUtil::TestVector> &test_list, size_t key_size)
{
    ...
    if (key_size == 128)
    {
         ...
         */
        {
            tc::ByteData base_key = tc::ByteData(
                {0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f});
            tc::ByteData base_iv =
                tc::ByteData({0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b});
            tc::ByteData base_add = tc::ByteData({0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09,
                                                  0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13});
            tc::ByteData base_msg =
                tc::ByteData({0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b,
            ...
            std::array<tc::ByteData, kTestNum> expected_mac = {
                tc::ByteData({0x4d, 0xac, 0x25, 0x5d}), tc::ByteData({0x1f, 0xc6, 0x4f, 0xbf, 0xac, 0xcd}),
            ...
            std::array<tc::ByteData, kTestNum> expected_ciphertext = {
                ...
                tc::ByteData({0xe3, 0xb2, 0x01, 0xa9, 0xf5, 0xb7, 0x1a, 0x7a, 0x9b, 0x1c, 0xea, 0xec,
                              0xcd, 0x97, 0xe7, 0x0b, 0x61, 0x76, 0xaa, 0xd9, 0xa4, 0x42, 0x8a, 0xa5})};
