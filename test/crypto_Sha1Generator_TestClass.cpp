...
crypto_Sha1Generator_TestClass::crypto_Sha1Generator_TestClass() : mTestTag("tc::crypto::Sha1Generator"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Sha1Generator::kHashSize != kExpectedHashSize)
        {
            throw tc::TestException(fmt::format(
                "kHashSize had value {:d} (expected {:d})", tc::crypto::Sha1Generator::kHashSize, kExpectedHashSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::Sha1Generator::kBlockSize,
                kExpectedBlockSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kAsn1OidData.size() had value {:d} (expected {:d})", tc::crypto::Sha1Generator::kAsn1OidData.size(),
                kExpectedAsn1OidData.size()));
        }
        if (memcmp(
                tc::crypto::Sha1Generator::kAsn1OidData.data(), kExpectedAsn1OidData.data(),
                kExpectedAsn1OidData.size()) != 0)
        {
            throw tc::TestException(fmt::format(
                "kAsn1OidData.data() had data {:s} (expected {:s})",
                tc::cli::FormatUtil::formatBytesAsString(
                    tc::crypto::Sha1Generator::kAsn1OidData.data(), tc::crypto::Sha1Generator::kAsn1OidData.size(),
                    true, ""),
    ...
    try
    {
        ...
        std::vector<TestCase> test_cases = {
            ...
            {"long string", "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
             tc::cli::FormatUtil::hexStringToBytes("84983E441C3BD26EBAAE4AA1F95129E5E54670F1")},
        };
...
void crypto_Sha1Generator_TestClass::test_NoInitNoUpdateDoHash()
{
    ...
    try
    {
        ...
        std::vector<TestCase> test_cases = {
            ...
            {"long string", "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
             tc::cli::FormatUtil::hexStringToBytes("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")},
        };
...
void crypto_Sha1Generator_TestClass::test_DoInitNoUpdateDoHash()
{
    ...
    try
    {
        ...
        std::vector<TestCase> test_cases = {
            ...
            {"long string", "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
             tc::cli::FormatUtil::hexStringToBytes("DA39A3EE5E6B4B0D3255BFEF95601890AFD80709")},
        };
