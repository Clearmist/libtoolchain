...
class crypto_HmacSha2512Generator_TestClass : public ITestClass
{
  public:
    crypto_HmacSha2512Generator_TestClass();
  ...
  private:
    ...
    void util_Setup_Rfc2202_TestCases(std::vector<crypto_HmacSha2512Generator_TestClass::TestCase> &test_cases);
};
