...
class crypto_CmacTdes112Generator_TestClass : public ITestClass
{
  public:
    crypto_CmacTdes112Generator_TestClass();
  ...
  private:
    ...
    void util_Setup_TestCases(std::vector<crypto_CmacTdes112Generator_TestClass::TestCase> &test_cases);
};
