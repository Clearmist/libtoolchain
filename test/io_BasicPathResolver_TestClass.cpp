...
io_BasicPathResolver_TestClass::io_BasicPathResolver_TestClass() : mTestTag("tc::io::BasicPathResolver"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (cur_dir != expected_cur_dir)
        {
            throw tc::TestException(fmt::format(
                ".getCurrentDirectory() returned the wrong path after default constructor (returned \"{}\", expected "
                "\"{}\")",
                (std::string)cur_dir, (std::string)expected_cur_dir));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                ".getExplicitRootLabels() returned the root label list after default constructor (returned {}, "
                "expected {})",
                root_labels, expected_root_labels));
        }
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException(
                ".setCurrentDirectory() failed to throw tc::ArgumentOutOfRangeException when passed an empty path");
        }
        ...
        {
            throw tc::TestException(fmt::format(
                ".getCurrentDirectory() returned the wrong path after .setCurrentDirectory() (returned \"{}\", "
                "expected \"{}\")",
                (std::string)cur_dir, (std::string)expected_cur_dir));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                ".getExplicitRootLabels() returned unexpected data list after .setCurrentDirectory() (returned {}, "
                "expected {})",
                root_labels, expected_root_labels));
        }
...
void io_BasicPathResolver_TestClass::test_setExplicitRootLabels()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                ".getExplicitRootLabels() returned unexpected data list after .setExplicitRootLabels() (returned {}, "
                "expected {})",
                root_labels, expected_root_labels));
        }
...
void io_BasicPathResolver_TestClass::test_ResolveRootDirRelativePaths()
{
    ...
    try
    {
        ...
        std::vector<ResolutionTest> tests = {
            ...
            {"/a/path/with/./some/././current/directory/aliases/./", "/a/working/directory",
             "/a/path/with/some/current/directory/aliases"},
            {"/a/path/with/./a/./../mix/./of/../../parent/and/../current/directory/aliases/./", "/a/working/directory",
             "/a/path/with/parent/current/directory/aliases"},
            {"/a/path/with/../../../more/../../parent/directory/../../../aliases/../than/../path/../elements/../..",
             "/a/working/directory", "/"},
        };

        for (auto itr = tests.begin(); itr != tests.end(); itr++)
        {
            util_RunResolutionTest(
                tc::io::Path(itr->in_path), tc::io::Path(itr->in_working_directory_path),
                tc::io::Path(itr->expected_resolved_path));
        }
...
void io_BasicPathResolver_TestClass::test_ResolveWorkingDirectoryRelativePaths()
{
    ...
    try
    {
        ...
        std::vector<ResolutionTest> tests = {
            ...
            {"a/path", "/a/working/directory", "/a/working/directory/a/path"},
            {"./a/path", "/a/very/long/working/directory/path/indeed/this/is/more/than/ten/elements",
             "/a/very/long/working/directory/path/indeed/this/is/more/than/ten/elements/a/path"},
            {"a/path", "/a/very/long/working/directory/path/indeed/this/is/more/than/ten/elements",
             "/a/very/long/working/directory/path/indeed/this/is/more/than/ten/elements/a/path"},
            {"./a/path/with/../some/../../parent/directory/aliases/../", "/a/working/directory",
             "/a/working/directory/a/parent/directory"},
            {"a/path/with/../some/../../parent/directory/aliases/../", "/a/working/directory",
             "/a/working/directory/a/parent/directory"},
            {"./a/path/with/./a/./../mix/./of/../../parent/and/../current/directory/aliases/./", "/a/working/directory",
             "/a/working/directory/a/path/with/parent/current/directory/aliases/"},
            {"a/path/with/./a/./../mix/./of/../../parent/and/../current/directory/aliases/./", "/a/working/directory",
             "/a/working/directory/a/path/with/parent/current/directory/aliases/"},
            {"./a/path/with/../../../more/../../parent/directory/../../../aliases/../than/../path/../elements/../../"
             "very/different/path",
             "/a/working/directory", "/very/different/path"},
            {"a/path/with/../../../more/../../parent/directory/../../../aliases/../than/../path/../elements/../../very/"
             "different/path",
             "/a/working/directory", "/very/different/path"},
    ...
    try
    {
        ...
        std::vector<ResolutionTest> tests = {
            {"Project\\MyFile.txt",
             ...
             {"C:", "D:"},
             "C:\\Users\\Administrator\\Desktop\\Project\\MyFile.txt"},
            {"C:\\Source\\Project\\MyFile.txt",
             "C:\\Users\\Administrator\\Desktop",
             {"C:", "D:"},
             "C:\\Source\\Project\\MyFile.txt"},
            {"D:\\Project\\MyFile.txt", "C:\\Users\\Administrator\\Desktop", {"C:", "D:"}, "D:\\Project\\MyFile.txt"},
            {"E:\\Project\\MyFile.txt",
             "C:\\Users\\Administrator\\Desktop",
             {"C:", "D:"},
             "C:\\Users\\Administrator\\Desktop\\E:\\Project\\MyFile.txt"},
        };

        for (auto itr = tests.begin(); itr != tests.end(); itr++)
        {
            util_RunResolutionTest(
                tc::io::Path(itr->in_path), tc::io::Path(itr->in_working_directory_path), itr->root_labels,
                tc::io::Path(itr->expected_resolved_path));
        }
...
void io_BasicPathResolver_TestClass::util_RunResolutionTest(
    const tc::io::Path &in_path, const tc::io::Path &in_working_dir_path, const tc::io::Path &expected_resolved_path)
{
    util_RunResolutionTest(in_path, in_working_dir_path, {}, expected_resolved_path);
}

void io_BasicPathResolver_TestClass::util_RunResolutionTest(
    const tc::io::Path &in_path,
    const tc::io::Path &in_working_dir_path,
    const std::vector<std::string> &root_labels,
    const tc::io::Path &expected_resolved_path)
{
    ...
    {
        throw tc::TestException(fmt::format(
            "Resolve (path=\"{:s}\", workingdir=\"{:s}\", rootlabels={}) returned \"{:s}\"  (expected: \"{:s}\").",
            (std::string)in_path, (std::string)in_working_dir_path, root_labels, (std::string)resolved_path,
            (std::string)expected_resolved_path));
    }
}