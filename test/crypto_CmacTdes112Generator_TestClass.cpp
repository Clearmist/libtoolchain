...
crypto_CmacTdes112Generator_TestClass::crypto_CmacTdes112Generator_TestClass()
    : mTestTag("tc::crypto::CmacTdes112Generator"), mTestResults()
{
}
...
void crypto_CmacTdes112Generator_TestClass::test_UtilFunc()
{
    ...
    try
    {
        ...
        {
            memset(mac.data(), 0xff, mac.size());
            tc::crypto::GenerateCmacTdes112Mac(
...
void crypto_CmacTdes112Generator_TestClass::util_Setup_TestCases(
    std::vector<crypto_CmacTdes112Generator_TestClass::TestCase> &test_cases)
{
    TestCase tmp;
    ...
    tmp.out_mac =
        tc::cli::FormatUtil::hexStringToBytes("4FF2AB813C53CE83"); // test data incorrectly had this as bd2ebf9a3ba00361
    test_cases.push_back(tmp);
    ...
    tmp.out_mac =
        tc::cli::FormatUtil::hexStringToBytes("62DD1B471902BD4E"); // test data incorrectly had this as 8ea92435b52660e0
    test_cases.push_back(tmp);
