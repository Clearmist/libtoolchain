...
bn_bitarrayByteLEBitLE_TestClass::bn_bitarrayByteLEBitLE_TestClass()
    : mTestTag("tc::bn::bitarray<LE,LE>"), mTestResults()
{
}
...
const std::string &bn_bitarrayByteLEBitLE_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &bn_bitarrayByteLEBitLE_TestClass::getTestResults() const
{
    return mTestResults;
}
...
void bn_bitarrayByteLEBitLE_TestClass::helper_TestBit(
