...
io_ConcatenatedStream_TestClass::io_ConcatenatedStream_TestClass()
    : mTestTag("tc::io::ConcatenatedStream"), mTestResults()
{
}
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException(
                ".read() failed to throw tc::ObjectDisposedException when class was not initilaized.");
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                ".write() failed to throw tc::ObjectDisposedException when class was not initilaized.");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                ".seek() failed to throw tc::ObjectDisposedException when class was not initilaized.");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        try
        {
            stream.setLength(0);
            throw tc::TestException(
                ".setLength() failed to throw tc::ObjectDisposedException when class was not initilaized.");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        try
        {
            stream.flush();
            throw tc::TestException(
                ".flush() failed to throw tc::ObjectDisposedException when class was not initilaized.");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        }
...
void io_ConcatenatedStream_TestClass::test_CreateConstructor_ThrowsOnBadInput()
{
    ...
    try
    {
        try
        {
            ...
            throw tc::TestException(
                ".ctor() did not throw tc::NotSupportedException where there were no input streams");
        }
        ...
        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{nullptr, nullptr, nullptr};

            tc::io::ConcatenatedStream stream = tc::io::ConcatenatedStream(streams);

            throw tc::TestException(
                ".ctor() did not throw tc::NotSupportedException where there were null input streams");
        }
        catch (tc::NotSupportedException &)
        { /* do nothing */
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                ".ctor() did not throw tc::NotSupportedException where there total length of input streams was 0.");
        }
        catch (tc::NotSupportedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".ctor() threw the wrong exception where there total length of input streams was 0.");
        }

        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                std::make_shared<StreamTestUtil::DummyStreamBase>(StreamTestUtil::DummyStreamBase(
                    0x100, false, true, true, false, false)), // canRead=false, canWrite=true, canSeek=true, ...
                std::make_shared<StreamTestUtil::DummyStreamBase>(StreamTestUtil::DummyStreamBase(
                    0x100, true, false, true, false, false)), // canRead=true, canWrite=false, canSeek=true, ...
                std::make_shared<StreamTestUtil::DummyStreamBase>(StreamTestUtil::DummyStreamBase(
                    0x100, true, true, true, false, false)) // canRead=true, canWrite=true, canSeek=true, ...
            };

            tc::io::ConcatenatedStream stream = tc::io::ConcatenatedStream(streams);

            throw tc::TestException(".ctor() did not throw tc::NotSupportedException where the input streams did not "
                                    "all support atleast either read or write.");
        }
        catch (tc::NotSupportedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(".ctor() threw the wrong exception where the input streams did not all support "
                                    "atleast either read or write.");
        }
...
void io_ConcatenatedStream_TestClass::test_CreateConstructor_SetsCorrectStreamState()
{
    ...
    try
    {
        ...
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, false, false, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, false, false, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, false, false, false, false))};
        ...
        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, false, false, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, false, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, false, false, false, false))};
        ...
        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, true, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, false, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, false, false, false))};
        ...
        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, true, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, false, true, true, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, true, false, false))};
        ...
        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, false, true, false, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, false, true, true, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, false, true, true, false, false))};
        ...
        // test 10) (all input streams, length=0x100, canRead=true, canWrite=true, canSeek=true) & one empty stream with
        // only read
        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                ...
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, true, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(StreamTestUtil::DummyStreamBase(
                    0x000, true, false, false, false, false)), // this should be skipped because it has no size
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, true, false, false)),
            };
        ...
        // test 11) (all input streams, length=0x100, canRead=true, canWrite=true, canSeek=true) & one populated stream
        // with only no read/write
        try
        {
            std::vector<std::shared_ptr<tc::io::IStream>> streams{
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                ...
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, true, false, false)),
                std::make_shared<StreamTestUtil::DummyStreamBase>(StreamTestUtil::DummyStreamBase(
                    0x100, false, false, false, false,
                    false)), // this should be skipped because it cannot be read or written too
                std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0x100, true, true, true, false, false)),
            };
...
void io_ConcatenatedStream_TestClass::test_setLength_ThrowsOnUse()
{
    ...
    try
    {
        ...
        try
        {
            stream.setLength(0);
            throw tc::TestException(
                ".setLength() did not throw tc::NotSupportedException when called from an initalized class.");
        }
...
void io_ConcatenatedStream_TestClass::test_write_ThrowsOnUnsupported()
{
    ...
    try
    {
        ...
        std::vector<std::shared_ptr<tc::io::IStream>> streams{
            std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0x100, true, false, true, false, false)),
            std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0x100, true, false, true, false, false)),
            std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0x100, true, false, true, false, false))};
...
void io_ConcatenatedStream_TestClass::test_seek_SeeksToBeginOnNegativeSeek()
{
    ...
    try
    {
        class ValidateSeekParamDummyStream : public StreamTestUtil::DummyStreamBase
        {
          public:
            ValidateSeekParamDummyStream(int64_t seek_offset, tc::io::SeekOrigin seek_origin)
                : DummyStreamBase(0x100, true, true, true, false, false), mExpectedSeekOffset(seek_offset),
            ...
            int64_t seek(int64_t offset, tc::io::SeekOrigin origin)
            {
                if (offset != mExpectedSeekOffset)
                {
                    throw tc::TestException(fmt::format(
                        "offset passed to seek() was 0x{:x} (expected 0x{:x}", offset, mExpectedSeekOffset));
                }
                ...
                if (origin != mExpectedSeekOrigin)
                {
                    ...
                    throw tc::TestException(fmt::format(
                        "origin passed to seek() was {:s} (expected {:s}", origin_str, expected_origin_str));
                }
        ...
        std::vector<Test> tests{
            {0x0, 0x0}, {-1, 0x0}, {-2, 0x0}, {-3, 0x0}, {-10, 0x0}, {-1000, 0x0}, {-20000, 0x0},
        };
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            {
                throw tc::TestException(fmt::format(
                    ".seek({}, tc::io::SeekOrigin::Begin) returned {} (expected {})", test->seek_pos, seek_res,
                    test->exp_seek_res));
            }
        }
...
void io_ConcatenatedStream_TestClass::test_seek_SeeksToEndOnTooLargeSeek()
{
    ...
    try
    {
        ...
        std::vector<Test> tests{
            {0x300, 0x300}, {0x301, 0x300},  {0x302, 0x300},   {0x310, 0x300},
            {0x400, 0x300}, {0x1000, 0x300}, {0x20000, 0x300},
        };
...
void io_ConcatenatedStream_TestClass::test_seek_CanFindCorrectStreamForSeek()
{
    ...
    try
    {
        ...
        class ReportsSeekPosParamDummyStream : public StreamTestUtil::DummyStreamBase
        {
          public:
            ReportsSeekPosParamDummyStream(SeekReport &seek_resport, size_t stream_id)
                : DummyStreamBase(0x100, true, true, true, false, false), mSeekReport(seek_resport),
                  mStreamId(stream_id)
            {
            }
        ...
        std::vector<std::shared_ptr<tc::io::IStream>> streams{
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 0)), // 0x000 - 0x0ff
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 1)), // 0x100 - 0x1ff
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 2)), // 0x200 - 0x2ff
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 3)), // 0x300 - 0x3ff
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 4)), // 0x400 - 0x4ff
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 5)), // 0x500 - 0x5ff
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 6)), // 0x600 - 0x6ff
            std::make_shared<ReportsSeekPosParamDummyStream>(
                ReportsSeekPosParamDummyStream(seek_report, 7)), // 0x700 - 0x7ff
        };
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            {
                throw tc::TestException(
                    fmt::format(".seek({}) returned {} (expected {})", test->seek_pos, seek_res, test->exp_seek_res));
            }

            if (seek_report.seek_pos != test->exp_seek_report.seek_pos ||
                seek_report.stream_id != test->exp_seek_report.stream_id)
            {
                throw tc::TestException(fmt::format(
                    ".seek({}) triggered .seek({}) in stream {} (expected .seek({}) in stream {})", test->seek_pos,
                    test->exp_seek_report.seek_pos, test->exp_seek_report.stream_id, seek_report.seek_pos,
                    seek_report.stream_id));
            }
        }
...
void io_ConcatenatedStream_TestClass::test_read_CanReadFromSingleStream()
{
    ...
    class ReportDummyStream : public StreamTestUtil::DummyStreamBase
    {
      public:
        struct SeekReport
        {
            ...
            {
                return seek_offset == other.seek_offset && stream_id == other.stream_id;
            }
        };
        ...
        struct ReadReport
        {
            ...
            {
                return read_ptr == other.read_ptr && read_count == other.read_count && stream_id == other.stream_id;
            }
        };

        ReportDummyStream(std::vector<ReadReport> &read_report, std::vector<SeekReport> &seek_report, size_t stream_id)
            : DummyStreamBase(0x100, true, true, true, false, false), mReadReport(read_report),
              mSeekReport(seek_report), mStreamId(stream_id)
        {
        }
        ...
        size_t read(byte_t *ptr, size_t count)
        {
            ...
            size_t readable_count =
                tc::io::IOUtil::getReadableCount(DummyStreamBase::length(), DummyStreamBase::position(), count);
    ...
    try
    {
        ...
        std::vector<Test> tests{
            ...
            {"ReadFromSomewhereElseInExistingStream",
             {0xe0},
             {},
             (byte_t *)0x1000,
             0x20,
             {{(byte_t *)0x1000, 0x20, 0}},
             {}},
        };
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            {
                throw tc::TestException(fmt::format(
                    "Test \"{}\" Failed: .read() issued to base streams were not as expected", test->test_name));
            }

            if (seek_report != test->exp_seek_report)
            {
                throw tc::TestException(fmt::format(
                    "Test \"{}\" Failed: .seek() issued to base streams were not as expected", test->test_name));
            }
        }
...
void io_ConcatenatedStream_TestClass::test_read_CanReadFromMultipleStreamWithSeekSupport()
{
    ...
    try
    {
        ...
        // create tests
        std::vector<Test> tests{
            {"ReadAllOfStream 0-7 (stream 0x0 positions)",
             {0x000, 0x100, 0x200, 0x300, 0x400, 0x500, 0x600, 0x700, 0x000},
             {},
             (byte_t *)0x1000,
             0x800,
             {{(byte_t *)0x1000, 0x100, 0},
              {(byte_t *)0x1100, 0x100, 1},
              {(byte_t *)0x1200, 0x100, 2},
              {(byte_t *)0x1300, 0x100, 3},
              {(byte_t *)0x1400, 0x100, 4},
              {(byte_t *)0x1500, 0x100, 5},
              {(byte_t *)0x1600, 0x100, 6},
              {(byte_t *)0x1700, 0x100, 7}},
             {}},
            {"ReadAllOfStream 0-7 (stream 0x80 positions)",
             {0x080, 0x180, 0x280, 0x380, 0x480, 0x580, 0x680, 0x780, 0x000},
             {},
             (byte_t *)0x1000,
             0x800,
             {{(byte_t *)0x1000, 0x100, 0},
            ...
            {"ReadAllOfStream 0-7 (stream 0x00 or 0x80 positions)",
             {0x080, 0x100, 0x280, 0x300, 0x480, 0x500, 0x680, 0x700, 0x000},
             {},
             (byte_t *)0x1000,
             0x800,
             {{(byte_t *)0x1000, 0x100, 0},
              ...
              {(byte_t *)0x1700, 0x100, 7}},
             {{0x0, 2}, {0x0, 4}, {0x0, 6}}},
            {"ReadAllOfStream 3-6 (stream 0x0 positions)",
             {0x000, 0x100, 0x200, 0x300, 0x400, 0x500, 0x600, 0x700, 0x300},
             {},
             (byte_t *)0x1000,
             0x400,
             {{(byte_t *)0x1000, 0x100, 3},
              {(byte_t *)0x1100, 0x100, 4},
              {(byte_t *)0x1200, 0x100, 5},
              {(byte_t *)0x1300, 0x100, 6}},
             {}},
            {"ReadAllOfStream 3-6 (stream 0x80 positions)",
             {0x080, 0x180, 0x280, 0x380, 0x480, 0x580, 0x680, 0x780, 0x300},
             {},
             (byte_t *)0x1000,
             0x400,
             {{(byte_t *)0x1000, 0x100, 3},
              ...
              {(byte_t *)0x1300, 0x100, 6}},
             {{0x0, 4}, {0x0, 5}, {0x0, 6}}},
            {"ReadStream (partial)3,4-5,(partial)6 (stream 0x0 positions)",
             {0x000, 0x100, 0x200, 0x300, 0x400, 0x500, 0x600, 0x700, 0x350},
             {},
             (byte_t *)0x1000,
             0x300,
             {{(byte_t *)0x1000, 0xB0, 3},
              {(byte_t *)0x10B0, 0x100, 4},
              {(byte_t *)0x11B0, 0x100, 5},
              {(byte_t *)0x12B0, 0x50, 6}},
             {}},
            {"ReadStream (partial)3,4-5,(partial)6 (stream 0x80 positions)",
             {0x080, 0x180, 0x280, 0x380, 0x480, 0x580, 0x680, 0x780, 0x350},
             {},
             (byte_t *)0x1000,
             0x300,
             {{(byte_t *)0x1000, 0xB0, 3},
...
void io_ConcatenatedStream_TestClass::test_read_CanReadFromMultipleStreamWithNoSeekSupport()
{
    ...
    class ReportDummyStream : public StreamTestUtil::DummyStreamBase
    {
      public:
        ...
        ReportDummyStream(std::vector<ReadReport> &read_report, std::vector<SeekReport> &seek_report, size_t stream_id)
            : DummyStreamBase(0x100, true, true, false, false, false), mReadReport(read_report),
              mSeekReport(seek_report), mStreamId(stream_id)
        {
        }
    ...
    try
    {
        ...
        std::vector<Test> tests{
            ...
            {"ReadStream (partial)0,1-4",
             {},
             {},
             (byte_t *)0x1000,
             0x460,
             {{(byte_t *)0x1000, 0x60, 0},
              {(byte_t *)0x1060, 0x100, 1},
              {(byte_t *)0x1160, 0x100, 2},
              {(byte_t *)0x1260, 0x100, 3},
              {(byte_t *)0x1360, 0x100, 4}},
             {}},
            {"ReadStream 5-7",
             {},
             {},
             (byte_t *)0x1000,
             0x300,
             {{(byte_t *)0x1000, 0x100, 5}, {(byte_t *)0x1100, 0x100, 6}, {(byte_t *)0x1200, 0x100, 7}},
             {}},
        };
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            if (read_report != test->exp_read_report)
            {
                ...
                {
                    fmt::print(
                        "ReadReport (ptr: 0x{:x}, count: 0x{:x}, stream: {:d})\n", (size_t)itr->read_ptr,
                        itr->read_count, itr->stream_id);
                }
...
void io_ConcatenatedStream_TestClass::test_read_ReadFromMultiStream_NoSeekSupport_ThrowsOnSeekRequired()
{
      ...
      public:
        ...
        ReportDummyStream(std::vector<ReadReport> &read_report, std::vector<SeekReport> &seek_report, size_t stream_id)
            : DummyStreamBase(0x100, 0x80, true, true, false, false, false), // the initial position is 0x80
              mReadReport(read_report), mSeekReport(seek_report), mStreamId(stream_id)
        {
        }
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException(".read() did not throw tc::io::IOException where stream required seeking to "
                                    "begining but did not support seeking.");
        }
        ...
        {
            throw tc::TestException(".read() threw the wrong exception where stream required seeking to begining but "
                                    "did not support seeking.");
        }
...
void io_ConcatenatedStream_TestClass::test_write_CanWriteFromSingleStream()
{
    ...
    class ReportDummyStream : public StreamTestUtil::DummyStreamBase
    {
      public:
        ...
        struct WriteReport
        {
            ...
            {
                return write_ptr == other.write_ptr && write_count == other.write_count && stream_id == other.stream_id;
            }
        };

        ReportDummyStream(
            std::vector<WriteReport> &write_report, std::vector<SeekReport> &seek_report, size_t stream_id)
            : DummyStreamBase(0x100, true, true, true, false, false), mWriteReport(write_report),
              mSeekReport(seek_report), mStreamId(stream_id)
        {
        }
        ...
        size_t write(const byte_t *ptr, size_t count)
        {
            ...
            size_t writable_count =
                tc::io::IOUtil::getWritableCount(DummyStreamBase::length(), DummyStreamBase::position(), count);
    ...
    try
    {
        ...
        std::vector<Test> tests{
            ...
            {"WriteFromSomewhereElseInExistingStream",
             {0xe0},
             {},
             (byte_t *)0x1000,
             0x20,
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            {
                throw tc::TestException(fmt::format(
                    "Test \"{}\" Failed: .write() issued to base streams were not as expected", test->test_name));
            }
...
void io_ConcatenatedStream_TestClass::test_write_CanWriteFromMultipleStreamWithSeekSupport()
{
    ...
    try
    {
        ...
        // create tests
        std::vector<Test> tests{
            {"WriteAllOfStream 0-7 (stream 0x0 positions)",
             {0x000, 0x100, 0x200, 0x300, 0x400, 0x500, 0x600, 0x700, 0x000},
             {},
             (byte_t *)0x1000,
             0x800,
             {{(byte_t *)0x1000, 0x100, 0},
              ...
              {(byte_t *)0x1700, 0x100, 7}},
             {}},
            {"WriteAllOfStream 0-7 (stream 0x80 positions)",
             {0x080, 0x180, 0x280, 0x380, 0x480, 0x580, 0x680, 0x780, 0x000},
             {},
             (byte_t *)0x1000,
             0x800,
             {{(byte_t *)0x1000, 0x100, 0},
              ...
              {(byte_t *)0x1700, 0x100, 7}},
             {{0x0, 1}, {0x0, 2}, {0x0, 3}, {0x0, 4}, {0x0, 5}, {0x0, 6}, {0x0, 7}}},
            {"WriteAllOfStream 0-7 (stream 0x00 or 0x80 positions)",
             {0x080, 0x100, 0x280, 0x300, 0x480, 0x500, 0x680, 0x700, 0x000},
             {},
             (byte_t *)0x1000,
             0x800,
             {{(byte_t *)0x1000, 0x100, 0},
              ...
              {(byte_t *)0x1700, 0x100, 7}},
             {{0x0, 2}, {0x0, 4}, {0x0, 6}}},
            {"WriteAllOfStream 3-6 (stream 0x0 positions)",
             {0x000, 0x100, 0x200, 0x300, 0x400, 0x500, 0x600, 0x700, 0x300},
             {},
             (byte_t *)0x1000,
             0x400,
             {{(byte_t *)0x1000, 0x100, 3},
              ...
              {(byte_t *)0x1300, 0x100, 6}},
             {}},
            {"WriteAllOfStream 3-6 (stream 0x80 positions)",
             {0x080, 0x180, 0x280, 0x380, 0x480, 0x580, 0x680, 0x780, 0x300},
             {},
             (byte_t *)0x1000,
             0x400,
             {{(byte_t *)0x1000, 0x100, 3},
              ...
              {(byte_t *)0x1300, 0x100, 6}},
             {{0x0, 4}, {0x0, 5}, {0x0, 6}}},
            {"WriteStream (partial)3,4-5,(partial)6 (stream 0x0 positions)",
             {0x000, 0x100, 0x200, 0x300, 0x400, 0x500, 0x600, 0x700, 0x350},
             {},
             (byte_t *)0x1000,
             0x300,
             {{(byte_t *)0x1000, 0xB0, 3},
              ...
              {(byte_t *)0x12B0, 0x50, 6}},
             {}},
            {"WriteStream (partial)3,4-5,(partial)6 (stream 0x80 positions)",
             {0x080, 0x180, 0x280, 0x380, 0x480, 0x580, 0x680, 0x780, 0x350},
             {},
             (byte_t *)0x1000,
             0x300,
...
void io_ConcatenatedStream_TestClass::test_write_CanWriteFromMultipleStreamWithNoSeekSupport()
{
    ...
    class ReportDummyStream : public StreamTestUtil::DummyStreamBase
    {
      public:
        ...
        ReportDummyStream(
            std::vector<WriteReport> &write_report, std::vector<SeekReport> &seek_report, size_t stream_id)
            : DummyStreamBase(0x100, true, true, false, false, false), mWriteReport(write_report),
              mSeekReport(seek_report), mStreamId(stream_id)
        {
        }
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            if (write_report != test->exp_write_report)
            {
                ...
                {
                    fmt::print(
                        "WriteReport (ptr: 0x{:x}, count: 0x{:x}, stream: {:d})\n", (size_t)itr->write_ptr,
                        itr->write_count, itr->stream_id);
                }
...
void io_ConcatenatedStream_TestClass::test_write_WriteFromMultiStream_NoSeekSupport_ThrowsOnSeekRequired()
{
    ...
    class ReportDummyStream : public StreamTestUtil::DummyStreamBase
    {
      public:
        ...
        ReportDummyStream(
            std::vector<WriteReport> &write_report, std::vector<SeekReport> &seek_report, size_t stream_id)
            : DummyStreamBase(0x100, 0x80, true, true, false, false, false), // the initial position is 0x80
              mWriteReport(write_report), mSeekReport(seek_report), mStreamId(stream_id)
        {
        }
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException(".write() did not throw tc::io::IOException where stream required seeking to "
                                    "begining but did not support seeking.");
        }
        catch (const tc::io::IOException &)
        { /* do nothing */
        ...
        {
            throw tc::TestException(".write() threw the wrong exception where stream required seeking to begining but "
                                    "did not support seeking.");
        }
...
void io_ConcatenatedStream_TestClass::test_MoveOperator_MoveDisposedToDisposed()
{
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException("stream_a was disposed upon construction, but failed throw "
                                    "tc::ObjectDisposedException when seek() was called");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                "stream_a was disposed upon construction, but threw the wrong exception when seek() was called");
        }
        ...
        try
        {
            ...
            throw tc::TestException("stream_b was disposed upon construction, but failed throw "
                                    "tc::ObjectDisposedException when seek() was called");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        ...
        {
            throw tc::TestException(
                "stream_b was disposed upon construction, but threw the wrong exception when seek() was called");
        }
        ...
        {
            throw tc::TestException(
                fmt::format("stream_a had wrong properies after it was move assigned to stream_b ({})", e.what()));
        }
        try
        {
            stream_a.seek(0, tc::io::SeekOrigin::Current);
            throw tc::TestException("stream_a was disposed upon being move assigned to stream_b, but failed throw "
                                    "tc::ObjectDisposedException when seek() was called");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        ...
        {
            throw tc::TestException("stream_a was disposed upon being move assigned to stream_b, but threw the wrong "
                                    "exception when seek() was called");
        }
        ...
        {
            throw tc::TestException(
                fmt::format("stream_b has wrong properties after being move assigned from stream_a ({})", e.what()));
        }
        try
        {
            stream_b.seek(0, tc::io::SeekOrigin::Current);
            throw tc::TestException("stream_b was disposed upon move assignment from stream_a, but failed throw "
                                    "tc::ObjectDisposedException when seek() was called");
        }
        catch (const tc::ObjectDisposedException &)
        { /* do nothing */
        ...
        {
            throw tc::TestException("stream_b was disposed upon move assignment from stream_a, but threw the wrong "
                                    "exception when seek() was called");
        }
...
void io_ConcatenatedStream_TestClass::test_MoveOperator_MoveInitializedToDisposed()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException("stream_a was initialized upon construction, but threw tc::ObjectDisposedException "
                                    "when seek() was called");
        }
        ...
        {
            throw tc::TestException("stream_b was initialized upon move assignment from stream_a, but threw "
                                    "tc::ObjectDisposedException when seek() was called");
        }
...
void io_ConcatenatedStream_TestClass::test_MoveOperator_MoveDisposedToInitialized()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException("stream_b was initialized upon construction, but threw tc::ObjectDisposedException "
                                    "when seek() was called");
        }
...
void io_ConcatenatedStream_TestClass::test_MoveOperator_MoveInitializedToInitialized()
{
    ...
    try
    {
        ...
        std::vector<std::shared_ptr<tc::io::IStream>> streams_b{
            std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0x200, true, true, true, false, false)),
            std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0x200, true, true, true, false, false)),
            std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0x200, true, true, true, false, false))};
