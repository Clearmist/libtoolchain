...
void PbkdfUtil::generatePbkdf1TestVectors_Custom(
    std::vector<PbkdfUtil::TestVector> &test_list, PbkdfUtil::HashAlgo hash_algo)
{
...
void PbkdfUtil::generatePbkdf2TestVectors_RFC6070(
    std::vector<PbkdfUtil::TestVector> &test_list, PbkdfUtil::HashAlgo hash_algo)
{
    std::array<PbkdfUtil::TestVector, 6> tests;
    ...
    else if (hash_algo == HashAlgo::SHA224)
    {
        ...
        tests[0].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("3c198cbdb9464b7857966bd05b7bc92bc1cc4e6e63155d4e490557fd");

        tests[1].in_dk_len = 28;
        tests[1].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("93200ffa96c5776d38fa10abdf8f5bfc0054b9718513df472d2331d2");

        tests[2].in_dk_len = 28;
        tests[2].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("218c453bf90635bd0a21a75d172703ff6108ef603f65bb821aedade1");

        tests[3].in_dk_len = 28;
        tests[3].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("b49925184cb4b559f365e94fcafcd4cdb9f7aef4a8ca8fcb4bd1ec53");

        tests[4].in_dk_len = 35;
        tests[4].out_dk = tc::cli::FormatUtil::hexStringToBytes(
    ...
    else if (hash_algo == HashAlgo::SHA256)
    {
        ...
        tests[0].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("120fb6cffcf8b32c43e7225256c4f837a86548c92ccc35480805987cb70be17b");

        tests[1].in_dk_len = 32;
        tests[1].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("ae4d0c95af6b46d32d0adff928f06dd02a303f8ef3c251dfd6e2d85a95474c43");

        tests[2].in_dk_len = 32;
        tests[2].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("c5e478d59288c841aa530db6845c4c8d962893a001ce4e11a4963873aa98134a");

        tests[3].in_dk_len = 32;
        tests[3].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("cf81c66fe8cfc04d1f31ecb65dab4089f7f179e89b3b0bcb17ad10e3ac6eba46");
    ...
    else if (hash_algo == HashAlgo::SHA384)
    {
        ...
        tests[0].out_dk = tc::cli::FormatUtil::hexStringToBytes(
            "c0e14f06e49e32d73f9f52ddf1d0c5c7191609233631dadd76a567db42b78676b38fc800cc53ddb642f5c74442e62be4");

        tests[1].in_dk_len = 48;
        tests[1].out_dk = tc::cli::FormatUtil::hexStringToBytes(
            "54f775c6d790f21930459162fc535dbf04a939185127016a04176a0730c6f1f4fb48832ad1261baadd2cedd50814b1c8");

        tests[2].in_dk_len = 48;
        tests[2].out_dk = tc::cli::FormatUtil::hexStringToBytes(
            "559726be38db125bc85ed7895f6e3cf574c7a01c080c3447db1e8a76764deb3c307b94853fbe424f6488c5f4f1289626");

        tests[3].in_dk_len = 48;
        tests[3].out_dk = tc::cli::FormatUtil::hexStringToBytes(
            "a7fdb349ba2bfa6bf647bb0161bae1320df27e640a04e8f11148c81229e2131af179c3b3423b38abf763dfe208c1fb67");

        tests[4].in_dk_len = 60;
        tests[4].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("819143ad66df9a552559b9e131c52ae6c5c1b0eed18f4d283b8c5c9eaeb92b392c14"
                                                  "7cc2d2869d58ffe2f7da13d15f8d925721f0ed1afafa24480d55");
    ...
    else if (hash_algo == HashAlgo::SHA512)
    {
        ...
        tests[0].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("867f70cf1ade02cff3752599a3a53dc4af34c7a669815ae5d513554e1c8cf252c02d"
                                                  "470a285a0501bad999bfe943c08f050235d7d68b1da55e63f73b60a57fce");

        tests[1].in_dk_len = 64;
        tests[1].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("e1d9c16aa681708a45f5c7c4e215ceb66e011a2e9f0040713f18aefdb866d53cf76c"
                                                  "ab2868a39b9f7840edce4fef5a82be67335c77a6068e04112754f27ccf4e");

        tests[2].in_dk_len = 64;
        tests[2].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("d197b1b33db0143e018b12f3d1d1479e6cdebdcc97c5c0f87f6902e072f457b5143f"
                                                  "30602641b3d55cd335988cb36b84376060ecd532e039b742a239434af2d5");

        tests[3].in_dk_len = 64;
        tests[3].out_dk =
            tc::cli::FormatUtil::hexStringToBytes("6180a3ceabab45cc3964112c811e0131bca93a35d17e833ebc221a40bd758ae83288"
                                                  "02896e40a54d2be21c7dd8e665f6490abbbdff6c5590bc656c9d0b3dad2a");

        tests[4].in_dk_len = 80;
        tests[4].out_dk = tc::cli::FormatUtil::hexStringToBytes(
            "8c0511f4c6e597c6ac6315d8f0362e225f3c501495ba23b868c005174dc4ee71115b59f9e60cd9532fa33e0f75aefe30225c583a18"
            "6cd82bd4daea9724a3d3b804f75bdd41494fa324cab24bcc680fb3");
