...
crypto_Aes128CbcEncryptedStream_TestClass::crypto_Aes128CbcEncryptedStream_TestClass()
    : mTestTag("tc::crypto::Aes128CbcEncryptedStream"), mTestResults()
{
}
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException(
                ".read() did not throw tc::ObjectDisposedException for uninitialized Aes128CbcEncryptedStream");
        }
        ...
        {
            throw tc::TestException(
                ".read() did not throw correct exception for uninitialized Aes128CbcEncryptedStream");
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                ".write() did not throw tc::ObjectDisposedException for uninitialized Aes128CbcEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".write() did not throw correct exception for uninitialized Aes128CbcEncryptedStream");
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                ".seek() did not throw tc::ObjectDisposedException for uninitialized Aes128CbcEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".seek() did not throw correct exception for uninitialized Aes128CbcEncryptedStream");
        }
        ...
        try
        {
            stream.setLength(0);
            throw tc::TestException(
                ".setLength() did not throw tc::ObjectDisposedException for uninitialized Aes128CbcEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".setLength() did not throw correct exception for uninitialized Aes128CbcEncryptedStream");
        }
        ...
        try
        {
            stream.flush();
            throw tc::TestException(
                ".flush() did not throw tc::ObjectDisposedException for uninitialized Aes128CbcEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".flush() did not throw correct exception for uninitialized Aes128CbcEncryptedStream");
        }
...
void crypto_Aes128CbcEncryptedStream_TestClass::test_CreateValidStream_CreateConstructor()
{
    ...
    try
    {
        ...
        try
        {
            stream.write(nullptr, 0);
            throw tc::TestException(
                ".write() did not throw tc::NotSupportedException for initialized Aes128CbcEncryptedStream");
        }
        ...
        {
            throw tc::TestException(
                ".write() did not throw correct exception for initialized Aes128CbcEncryptedStream");
        }
        ...
        try
        {
            stream.setLength(0);
            throw tc::TestException(
                ".setLength() did not throw tc::NotSupportedException for initialized Aes128CbcEncryptedStream");
        }
        catch (tc::NotSupportedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".setLength() did not throw correct exception for initialized Aes128CbcEncryptedStream");
        }
...
void crypto_Aes128CbcEncryptedStream_TestClass::util_Setup_TestCases(
    std::vector<crypto_Aes128CbcEncryptedStream_TestClass::TestCase> &test_cases)
{
    TestCase tmp;
    ...
    tc::ByteData ciphertext =
        tc::cli::FormatUtil::hexStringToBytes("7649abac8119b246cee98e9b12e9197d5086cb9b507219ee95db113a917678b273bed6b8"
                                              "e3c1743b7116e69e222295163ff1caa1681fac09120eca307586e1a7");
