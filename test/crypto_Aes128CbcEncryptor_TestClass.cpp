...
crypto_Aes128CbcEncryptor_TestClass::crypto_Aes128CbcEncryptor_TestClass()
    : mTestTag("tc::crypto::Aes128CbcEncryptor"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Aes128CbcEncryptor::kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::Aes128CbcEncryptor::kBlockSize,
                kExpectedBlockSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kKeySize had value {:d} (expected {:d})", tc::crypto::Aes128CbcEncryptor::kKeySize, kExpectedKeySize));
        }
...
void crypto_Aes128CbcEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
    ...
    try
    {
        ...
        // create data
        tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Aes128CbcEncryptor::kBlockSize)
                                        .pullData(0, tc::crypto::Aes128CbcEncryptor::kBlockSize);
...
void crypto_Aes128CbcEncryptor_TestClass::test_InitializeThrowsExceptionOnBadInput()
{
    ...
    try
    {
        ...
        {
            cryptor.initialize(
                tests[0].key.data(), tc::crypto::Aes128CbcEncryptor::kKeySize - 1, tests[0].iv.data(),
                tests[0].iv.size());
        ...
        try
        {
            cryptor.initialize(
                ...
                tc::crypto::Aes128CbcEncryptor::kBlockSize - 1);
