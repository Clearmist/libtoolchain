...
Optional_TestClass::Optional_TestClass() : mTestTag("tc::Optional"), mTestResults() {}
    ...
    try
    {
        ...
        if (foo.isNull() == false)
        {
            throw tc::TestException(
                "Default constructor created an object with null state, but isNull() returned false");
        }
...
void Optional_TestClass::testWrapConstructor()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(
                "Wrapping constructor created an object with a valid state, but isNull() returned true");
        }

        if (foo.isSet() == false)
        {
            throw tc::TestException(
                "Wrapping constructor created an object with a valid state, but isSet() returned false");
        }
...
void Optional_TestClass::testCopyConstructorFromNullOptional()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(
                "Copy constructor created an object with a null state, but isNull() returned false");
        }
