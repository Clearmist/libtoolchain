...
bn_bitarrayByteBEBitLE_TestClass::bn_bitarrayByteBEBitLE_TestClass()
    : mTestTag("tc::bn::bitarray<BE,LE>"), mTestResults()
{
}
...
const std::string &bn_bitarrayByteBEBitLE_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &bn_bitarrayByteBEBitLE_TestClass::getTestResults() const
{
    return mTestResults;
}
...
void bn_bitarrayByteBEBitLE_TestClass::helper_TestBit(
