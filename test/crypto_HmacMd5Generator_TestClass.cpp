...
crypto_HmacMd5Generator_TestClass::crypto_HmacMd5Generator_TestClass()
    : mTestTag("tc::crypto::HmacMd5Generator"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::HmacMd5Generator::kMacSize != kExpectedMacSize)
        {
            throw tc::TestException(fmt::format(
                "kMacSize had value {:d} (expected {:d})", tc::crypto::HmacMd5Generator::kMacSize, kExpectedMacSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::HmacMd5Generator::kBlockSize,
                kExpectedBlockSize));
        }
...
void crypto_HmacMd5Generator_TestClass::util_Setup_Rfc2202_TestCases(
    std::vector<crypto_HmacMd5Generator_TestClass::TestCase> &test_cases)
{
    TestCase tmp;
