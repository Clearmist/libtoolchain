...
crypto_Aes256CbcEncryptor_TestClass::crypto_Aes256CbcEncryptor_TestClass()
    : mTestTag("tc::crypto::Aes256CbcEncryptor"), mTestResults()
{
}
...
const std::string &crypto_Aes256CbcEncryptor_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &crypto_Aes256CbcEncryptor_TestClass::getTestResults() const
{
    return mTestResults;
}
    ...
    try
    {
        ...
        if (tc::crypto::Aes256CbcEncryptor::kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::Aes256CbcEncryptor::kBlockSize,
                kExpectedBlockSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kKeySize had value {:d} (expected {:d})", tc::crypto::Aes256CbcEncryptor::kKeySize, kExpectedKeySize));
        }
...
void crypto_Aes256CbcEncryptor_TestClass::test_UseClassEnc()
{
    ...
    try
    {
        ...
        AesCbcEncryptorUtil::generateAesCbcTestVectors_Nist(tests, 256);
...
void crypto_Aes256CbcEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
    ...
    try
    {
        ...
        // create data
        tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Aes256CbcEncryptor::kBlockSize)
                                        .pullData(0, tc::crypto::Aes256CbcEncryptor::kBlockSize);
...
void crypto_Aes256CbcEncryptor_TestClass::test_InitializeThrowsExceptionOnBadInput()
{
    ...
    try
    {
        ...
        {
            cryptor.initialize(
                tests[0].key.data(), tc::crypto::Aes256CbcEncryptor::kKeySize - 1, tests[0].iv.data(),
                tests[0].iv.size());
        ...
        try
        {
            cryptor.initialize(
                ...
                tc::crypto::Aes256CbcEncryptor::kBlockSize - 1);
