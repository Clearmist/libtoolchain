...
crypto_Aes128CtrEncryptedStream_TestClass::crypto_Aes128CtrEncryptedStream_TestClass()
    : mTestTag("tc::crypto::Aes128CtrEncryptedStream"), mTestResults()
{
}
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException(
                ".read() did not throw tc::ObjectDisposedException for uninitialized Aes128CtrEncryptedStream");
        }
        ...
        {
            throw tc::TestException(
                ".read() did not throw correct exception for uninitialized Aes128CtrEncryptedStream");
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                ".write() did not throw tc::ObjectDisposedException for uninitialized Aes128CtrEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".write() did not throw correct exception for uninitialized Aes128CtrEncryptedStream");
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                ".seek() did not throw tc::ObjectDisposedException for uninitialized Aes128CtrEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".seek() did not throw correct exception for uninitialized Aes128CtrEncryptedStream");
        }
        ...
        try
        {
            stream.setLength(0);
            throw tc::TestException(
                ".setLength() did not throw tc::ObjectDisposedException for uninitialized Aes128CtrEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".setLength() did not throw correct exception for uninitialized Aes128CtrEncryptedStream");
        }
        ...
        try
        {
            stream.flush();
            throw tc::TestException(
                ".flush() did not throw tc::ObjectDisposedException for uninitialized Aes128CtrEncryptedStream");
        }
        catch (tc::ObjectDisposedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".flush() did not throw correct exception for uninitialized Aes128CtrEncryptedStream");
        }
...
void crypto_Aes128CtrEncryptedStream_TestClass::test_CreateValidStream_CreateConstructor()
{
    ...
    try
    {
        ...
        try
        {
            stream.write(nullptr, 0);
            throw tc::TestException(
                ".write() did not throw tc::NotSupportedException for initialized Aes128CtrEncryptedStream");
        }
        ...
        {
            throw tc::TestException(
                ".write() did not throw correct exception for initialized Aes128CtrEncryptedStream");
        }
        ...
        try
        {
            stream.setLength(0);
            throw tc::TestException(
                ".setLength() did not throw tc::NotSupportedException for initialized Aes128CtrEncryptedStream");
        }
        catch (tc::NotSupportedException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                ".setLength() did not throw correct exception for initialized Aes128CtrEncryptedStream");
        }
        ...
        for (auto itr = test_cases.begin(); itr != test_cases.end(); itr++)
        {
            ...
            try
            {
                ...
                StreamTestUtil::read_TestHelper(
                    stream, itr->read_offset, tc::io::SeekOrigin::Begin, itr->read_size, itr->read_size,
                    itr->read_plaintext.size(), itr->read_offset + int64_t(itr->read_size), itr->read_plaintext.data());
            }
...
void crypto_Aes128CtrEncryptedStream_TestClass::util_Setup_TestCases(
    std::vector<crypto_Aes128CtrEncryptedStream_TestClass::TestCase> &test_cases)
{
    TestCase tmp;
    ...
    tc::ByteData plaintext =
        tc::cli::FormatUtil::hexStringToBytes("6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46"
                                              "a35ce411e5fbc1191a0a52eff69f2445df4f9b17ad2b417be66c3710");
    tc::ByteData ciphertext =
        tc::cli::FormatUtil::hexStringToBytes("874d6191b620e3261bef6864990db6ce9806f66b7970fdff8617187bb9fffdff5ae4df3e"
                                              "dbd5d35e5b4f09020db03eab1e031dda2fbe03d1792170a0f3009cee");
