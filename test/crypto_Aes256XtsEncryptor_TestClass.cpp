...
crypto_Aes256XtsEncryptor_TestClass::crypto_Aes256XtsEncryptor_TestClass()
    : mTestTag("tc::crypto::Aes256XtsEncryptor"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Aes256XtsEncryptor::kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::Aes256XtsEncryptor::kBlockSize,
                kExpectedBlockSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kKeySize had value {:d} (expected {:d})", tc::crypto::Aes256XtsEncryptor::kKeySize, kExpectedKeySize));
        }
...
void crypto_Aes256XtsEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
    ...
    try
    {
        ...
        // create data
        tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Aes256XtsEncryptor::kBlockSize)
                                        .pullData(0, tc::crypto::Aes256XtsEncryptor::kBlockSize);
...
void crypto_Aes256XtsEncryptor_TestClass::test_InitializeThrowsExceptionOnBadInput()
{
    ...
    try
    {
        ...
        {
            cryptor.initialize(
                tests[0].key1.data(), tc::crypto::Aes256XtsEncryptor::kKeySize - 1, tests[0].key2.data(),
        ...
        try
        {
            cryptor.initialize(
                ...
                tc::crypto::Aes256XtsEncryptor::kKeySize - 1, tests[0].data_unit, true);
        ...
        try
        {
            cryptor.initialize(
                ...
                tc::crypto::Aes256XtsEncryptor::kBlockSize - 1, true);
