...
crypto_Md5Generator_TestClass::crypto_Md5Generator_TestClass() : mTestTag("tc::crypto::Md5Generator"), mTestResults() {}
    ...
    try
    {
        ...
        if (tc::crypto::Md5Generator::kHashSize != kExpectedHashSize)
        {
            throw tc::TestException(fmt::format(
                "kHashSize had value {:d} (expected {:d})", tc::crypto::Md5Generator::kHashSize, kExpectedHashSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::Md5Generator::kBlockSize, kExpectedBlockSize));
        }
        ...
        tc::ByteData kExpectedAsn1OidData =
            tc::cli::FormatUtil::hexStringToBytes("3020300C06082A864886F70D020505000410");
        ...
        {
            throw tc::TestException(fmt::format(
                "kAsn1OidData.size() had value {:d} (expected {:d})", tc::crypto::Md5Generator::kAsn1OidData.size(),
                kExpectedAsn1OidData.size()));
        }
        if (memcmp(
                tc::crypto::Md5Generator::kAsn1OidData.data(), kExpectedAsn1OidData.data(),
                kExpectedAsn1OidData.size()) != 0)
        {
            throw tc::TestException(fmt::format(
                "kAsn1OidData.data() had data {:s} (expected {:s})",
                tc::cli::FormatUtil::formatBytesAsString(
                    tc::crypto::Md5Generator::kAsn1OidData.data(), tc::crypto::Md5Generator::kAsn1OidData.size(), true,
                    ""),
    ...
    try
    {
        ...
        std::vector<TestCase> test_cases = {
            ...
            {"short string (\"abc\")", "abc",
             tc::cli::FormatUtil::hexStringToBytes("900150983CD24FB0D6963F7D28E17F72")},
            {"long string (\"message digest\")", "message digest",
             tc::cli::FormatUtil::hexStringToBytes("F96B697D7CB7938D525A2F31AAF161D0")},
            {"long string (alphabet)", "abcdefghijklmnopqrstuvwxyz",
             tc::cli::FormatUtil::hexStringToBytes("C3FCD3D76192E4007DFB496CCA67E13B")},
            {"long string (alphanum)", "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",
             tc::cli::FormatUtil::hexStringToBytes("D174AB98D277D9F5A5611C2C9F419D9F")},
            {"long string (numerals)",
             "12345678901234567890123456789012345678901234567890123456789012345678901234567890",
             tc::cli::FormatUtil::hexStringToBytes("57EDF4A22BE3C955AC49DA2E2107B67A")},
        };
...
void crypto_Md5Generator_TestClass::test_NoInitNoUpdateDoHash()
{
    ...
    try
    {
        ...
        std::vector<TestCase> test_cases = {
            ...
            {"short string (\"abc\")", "abc",
             tc::cli::FormatUtil::hexStringToBytes("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")},
            {"long string (\"message digest\")", "message digest",
             tc::cli::FormatUtil::hexStringToBytes("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")},
            {"long string (alphabet)", "abcdefghijklmnopqrstuvwxyz",
             tc::cli::FormatUtil::hexStringToBytes("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")},
...
void crypto_Md5Generator_TestClass::test_DoInitNoUpdateDoHash()
{
    ...
    try
    {
        ...
        std::vector<TestCase> test_cases = {
            ...
            {"short string (\"abc\")", "abc",
             tc::cli::FormatUtil::hexStringToBytes("D41D8CD98F00B204E9800998ECF8427E")},
            {"long string (\"message digest\")", "message digest",
             tc::cli::FormatUtil::hexStringToBytes("D41D8CD98F00B204E9800998ECF8427E")},
            {"long string (alphabet)", "abcdefghijklmnopqrstuvwxyz",
             tc::cli::FormatUtil::hexStringToBytes("D41D8CD98F00B204E9800998ECF8427E")},
