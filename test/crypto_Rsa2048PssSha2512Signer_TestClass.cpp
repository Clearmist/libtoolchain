...
crypto_Rsa2048PssSha2512Signer_TestClass::crypto_Rsa2048PssSha2512Signer_TestClass()
    : mTestTag("tc::crypto::Rsa2048PssSha2512Signer"), mTestResults()
{
}

void crypto_Rsa2048PssSha2512Signer_TestClass::runAllTests(void)
{
    test_Constants();
    test_UseClassSign();
    test_UseClassVerify();
...
const std::string &crypto_Rsa2048PssSha2512Signer_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &crypto_Rsa2048PssSha2512Signer_TestClass::getTestResults() const
{
    return mTestResults;
}
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_Constants()
{
    ...
    try
    {
        ...
        if (tc::crypto::Rsa2048PssSha2512Signer::kSignatureSize != kExpectedSignatureSize)
        {
            throw tc::TestException(fmt::format(
                "kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa2048PssSha2512Signer::kSignatureSize,
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_UseClassSign()
{
    TestResult test_result;
    ...
    try
    {
        ...
        tc::crypto::Rsa2048PssSha2512Signer signer;
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_UseClassVerify()
{
    TestResult test_result;
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_UseUtilFuncSign()
{
    TestResult test_result;
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test sign
            bool result = tc::crypto::SignRsa2048PssSha2512(
            ...
            result = tc::crypto::VerifyRsa2048PssSha2512(
                signature.data(), test->message_digest.data(),
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_UseUtilFuncVerify()
{
    TestResult test_result;
    ...
    try
    {
        ...
        {
            // test verify
            bool result = tc::crypto::VerifyRsa2048PssSha2512(
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_DoesNothingWhenNotInit()
{
    TestResult test_result;
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_InitializeThrowsExceptionOnBadInput()
{
    TestResult test_result;
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_SignReturnsFalseOnBadInput()
{
    TestResult test_result;
...
void crypto_Rsa2048PssSha2512Signer_TestClass::test_VerifyReturnsFalseOnBadInput()
{
    TestResult test_result;
