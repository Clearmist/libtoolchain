...
crypto_Pbkdf1Sha1KeyDeriver_TestClass::crypto_Pbkdf1Sha1KeyDeriver_TestClass()
    : mTestTag("tc::crypto::Pbkdf1Sha1KeyDeriver"), mTestResults()
{
}
...
const std::string &crypto_Pbkdf1Sha1KeyDeriver_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &crypto_Pbkdf1Sha1KeyDeriver_TestClass::getTestResults() const
{
    return mTestResults;
}
    ...
    try
    {
        ...
        if (tc::crypto::Pbkdf1Sha1KeyDeriver::kMaxDerivableSize != kExpectedMaxDerivableSize)
        {
            throw tc::TestException(fmt::format(
                ...
                tc::crypto::Pbkdf1Sha1KeyDeriver::kMaxDerivableSize, kExpectedMaxDerivableSize));
        }
...
void crypto_Pbkdf1Sha1KeyDeriver_TestClass::test_WillThrowExceptionOnZeroRounds()
{
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException("DeriveKeyPbkdf1Sha1() Did not throw tc::crypto::CryptoException where the round "
        ...
        catch (const tc::Exception &)
        {
            throw tc::TestException(
                "DeriveKeyPbkdf1Sha1() Threw the wrong exception where the round count was set to zero.");
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                "Pbkdf1Sha1KeyDeriver::initialize() Did not throw exception where the round count was set to zero.");
        }
        catch (const tc::crypto::CryptoException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                "Pbkdf1Sha1KeyDeriver::initialize() Threw the wrong exception where the round count was set to zero.");
        }
...
void crypto_Pbkdf1Sha1KeyDeriver_TestClass::test_WillThrowExceptionOnTooLargeDkSize()
{
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException("DeriveKeyPbkdf1Sha1() Did not throw tc::crypto::CryptoException where the derived "
        ...
        {
            throw tc::TestException("DeriveKeyPbkdf1Sha1() Threw the wrong exception where the derived data length "
        ...
        try
        {
            ...
            throw tc::TestException("Pbkdf1Sha1KeyDeriver::getBytes() Did not throw tc::crypto::CryptoException where "
                                    "the derived data length would exceed the maximum.");
        }
        catch (const tc::crypto::CryptoException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException("Pbkdf1Sha1KeyDeriver::getBytes() Threw the wrong exception where the derived data "
                                    "length would exceed the maximum.");
        }
