...
crypto_Rsa1024Pkcs1Sha1Signer_TestClass::crypto_Rsa1024Pkcs1Sha1Signer_TestClass()
    : mTestTag("tc::crypto::Rsa1024Pkcs1Sha1Signer"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Rsa1024Pkcs1Sha1Signer::kSignatureSize != kExpectedSignatureSize)
        {
            throw tc::TestException(fmt::format(
                "kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa1024Pkcs1Sha1Signer::kSignatureSize,
...
void crypto_Rsa1024Pkcs1Sha1Signer_TestClass::test_UseUtilFuncSign()
{
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test sign
            bool result = tc::crypto::SignRsa1024Pkcs1Sha1(
...
void crypto_Rsa1024Pkcs1Sha1Signer_TestClass::test_UseUtilFuncVerify()
{
    ...
    try
    {
        ...
        {
            // test verify
            bool result = tc::crypto::VerifyRsa1024Pkcs1Sha1(
