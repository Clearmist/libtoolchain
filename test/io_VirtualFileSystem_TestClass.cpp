...
io_VirtualFileSystem_TestClass::io_VirtualFileSystem_TestClass() : mTestTag("tc::io::VirtualFileSystem"), mTestResults()
{
}
        ...
        try
        {
            ...
            if (state_ulong != expected_state_ulong)
            {
                throw tc::TestException(fmt::format(
                    ".state().to_ulong() returned 0x{:x} (expected 0x{:x})", state_ulong, expected_state_ulong));
            }
            ...
            {
                throw tc::TestException(fmt::format(
                    ".state().test(tc::RESFLAG_READY) returned {} (expected {})", state_test_ready,
                    expected_state_test_ready));
            }
            ...
            {
                throw tc::TestException(fmt::format(
                    ".state().test(tc::RESFLAG_ERROR) returned {} (expected {})", state_test_error,
                    expected_state_test_error));
            }
            ...
            {
                throw tc::TestException(fmt::format(
                    ".state().test(tc::RESFLAG_NOINIT) returned {} (expected {})", state_test_noinit,
                    expected_state_test_noinit));
            }
            ...
            try
            {
                ...
                throw tc::TestException(
                    ".createFile() did not throw tc::ObjectDisposedException for uninitialized VirtualFileSystem");
            }
            ...
            try
            {
                ...
                throw tc::TestException(
                    ".removeFile() did not throw tc::ObjectDisposedException for uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                ...
                throw tc::TestException(
                    ".openFile() did not throw tc::ObjectDisposedException for uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                ...
                throw tc::TestException(
                    ".createDirectory() did not throw tc::ObjectDisposedException for uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".createDirectory() threw the wrong exception for uninitialized VirtualFileSystem");
            }

            try
            {
                filesystem.createDirectoryPath(tc::io::Path());
                throw tc::TestException(".createDirectoryPath() did not throw tc::ObjectDisposedException for "
                                        "uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".createDirectoryPath() threw the wrong exception for uninitialized VirtualFileSystem");
            }
            ...
            try
            {
                ...
                throw tc::TestException(
                    ".removeDirectory() did not throw tc::ObjectDisposedException for uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".removeDirectory() threw the wrong exception for uninitialized VirtualFileSystem");
            }
            ...
            try
            {
                ...
                throw tc::TestException(".getCanonicalPath() did not throw tc::ObjectDisposedException for "
                                        "uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            ...
            {
                throw tc::TestException(
                    ".getCanonicalPath() threw the wrong exception for uninitialized VirtualFileSystem");
            }
            ...
            try
            {
                ...
                throw tc::TestException(".getWorkingDirectory() did not throw tc::ObjectDisposedException for "
                                        "uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            ...
            {
                throw tc::TestException(
                    ".getWorkingDirectory() threw the wrong exception for uninitialized VirtualFileSystem");
            }

            try
            {
                filesystem.setWorkingDirectory(tc::io::Path());
                throw tc::TestException(".setWorkingDirectory() did not throw tc::ObjectDisposedException for "
                                        "uninitialized VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            ...
            {
                throw tc::TestException(
                    ".setWorkingDirectory() threw the wrong exception for uninitialized VirtualFileSystem");
            }
    ...
    try
    {
        try
        {
            try
            {
                ...
                throw tc::TestException(
                    "Create Constructor did not throw tc::InvalidOperationException for an unpopulated fs snapshot.");
            }
            ...
            try
            {
                ...
                fileA_entry.stream = std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0xA, true, false, true, false, false));

                tc::io::VirtualFileSystem::FileSystemSnapshot::FileEntry fileB_entry;
                fileB_entry.stream = std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0xB, true, false, true, false, false));

                tc::io::VirtualFileSystem::FileSystemSnapshot::FileEntry fileC_entry;
                fileC_entry.stream = std::make_shared<StreamTestUtil::DummyStreamBase>(
                    StreamTestUtil::DummyStreamBase(0xC, true, false, true, false, false));

                // add data to snapshot
                /* // omit including dir_entry
                snapshot.dir_entries.push_back(dirRoot_entry);
                snapshot.dir_entry_path_map.insert(std::pair<tc::io::Path, size_t>(dirRoot_entry.dir_listing.abs_path,
                snapshot.dir_entries.size()-1));
                */
                snapshot.dir_entries.push_back(dirA_entry);
                snapshot.dir_entry_path_map.insert(
                    std::pair<tc::io::Path, size_t>(dirA_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));

                snapshot.dir_entries.push_back(dirB_entry);
                snapshot.dir_entry_path_map.insert(
                    std::pair<tc::io::Path, size_t>(dirB_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));

                snapshot.dir_entries.push_back(dirC_entry);
                snapshot.dir_entry_path_map.insert(
                    std::pair<tc::io::Path, size_t>(dirC_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));

                snapshot.file_entries.push_back(fileA_entry);
                snapshot.file_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                    dirRoot_entry.dir_listing.abs_path + tc::io::Path("fileA"), snapshot.file_entries.size() - 1));

                snapshot.file_entries.push_back(fileB_entry);
                snapshot.file_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                    dirRoot_entry.dir_listing.abs_path + tc::io::Path("fileB"), snapshot.file_entries.size() - 1));

                snapshot.file_entries.push_back(fileC_entry);
                snapshot.file_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                    dirRoot_entry.dir_listing.abs_path + tc::io::Path("fileC"), snapshot.file_entries.size() - 1));

                // create filesystem
                auto filesystem = tc::io::VirtualFileSystem(snapshot);

                throw tc::TestException("Create Constructor did not throw tc::InvalidOperationException for a fs "
                                        "snapshot that did not have a root directory.");
            }
            catch (tc::InvalidOperationException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException("Create Constructor threw the wrong exception for a fs snapshot that did not "
            ...
            try
            {
                ...
                // add data to snapshot
                snapshot.dir_entries.push_back(dirRoot_entry);
                snapshot.dir_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                    dirRoot_entry.dir_listing.abs_path, -1)); // invalid index for root entry
                ...
                throw tc::TestException("Create Constructor did not throw tc::InvalidOperationException for a fs "
                                        "snapshot that had an invalid root directory index.");
            }
            catch (tc::InvalidOperationException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException("Create Constructor threw the wrong exception for a fs snapshot that had an "
                                        "invalid root directory index.");
            }
...
void io_VirtualFileSystem_TestClass::test_CreateFs_CreateConstructor()
{
    ...
    try
    {
        try
        {
            ...
            snapshot.dir_entries.push_back(dirRoot_entry);
            snapshot.dir_entry_path_map.insert(
                std::pair<tc::io::Path, size_t>(dirRoot_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));
            ...
            try
            {
                filesystem.createFile(tc::io::Path());
                throw tc::TestException(
                    ".createFile() did not throw tc::NotSupportedException for initialized VirtualFileSystem");
            }
            ...
            try
            {
                filesystem.removeFile(tc::io::Path());
                throw tc::TestException(
                    ".removeFile() did not throw tc::NotSupportedException for initialized VirtualFileSystem");
            }
            catch (tc::NotSupportedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                filesystem.createDirectory(tc::io::Path());
                throw tc::TestException(
                    ".createDirectory() did not throw tc::NotSupportedException for initialized VirtualFileSystem");
            }
            catch (tc::NotSupportedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".createDirectory() threw the wrong exception for initialized VirtualFileSystem");
            }
            ...
            try
            {
                filesystem.createDirectoryPath(tc::io::Path());
                throw tc::TestException(
                    ".createDirectoryPath() did not throw tc::NotSupportedException for initialized VirtualFileSystem");
            }
            catch (tc::NotSupportedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".createDirectoryPath() threw the wrong exception for initialized VirtualFileSystem");
            }
            ...
            try
            {
                filesystem.removeDirectory(tc::io::Path());
                throw tc::TestException(
                    ".removeDirectory() did not throw tc::NotSupportedException for initialized VirtualFileSystem");
            }
            catch (tc::NotSupportedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".removeDirectory() threw the wrong exception for initialized VirtualFileSystem");
            }
        ...
        try
        {
            ...
            */
            ...
            try
            {
                ...
                throw tc::TestException(fmt::format(
                    ".openFile() did not throw tc::NotSupportedException where unsupported mode ({:s}) and access "
                    "({:s}) were used.",
                    "CreateNew", "Read"));
            }
            ...
            {
                throw tc::TestException(fmt::format(
                    ".openFile() threw the wrong exception where unsupported mode ({:s}) and access ({:s}) were used.",
                    "CreateNew", "Read"));
            }
    ...
    try
    {
        try
        {
            try
            {
                ...
                snapshot.dir_entries.push_back(dirRoot_entry);
                snapshot.dir_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                    dirRoot_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));
                ...
                // snapshot.file_entries.push_back(fileB_entry);
                // snapshot.file_entry_path_map.insert(std::pair<tc::io::Path,
                // size_t>(dirRoot_entry.dir_listing.abs_path + tc::io::Path("fileB"), snapshot.file_entries.size()-1));
                ...
                throw tc::TestException(
                    ".openFile() did not throw tc::io::FileNotFoundException where file entry did not exist");
            }
            ...
            try
            {
                ...
                throw tc::TestException(".openFile() did not throw tc::io::FileNotFoundException where file entry did "
                                        "exist, but not mapped to a path");
            }
            catch (tc::io::FileNotFoundException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".openFile() threw the wrong exception where file entry did exist, but not mapped to a path");
            }
            ...
            try
            {
                ...
                snapshot.file_entries.push_back(fileB_entry);
                snapshot.file_entry_path_map.insert(
                    std::pair<tc::io::Path, size_t>(dirRoot_entry.dir_listing.abs_path + tc::io::Path("fileB"), -1));
            ...
            {
                throw tc::TestException(
                    ".openFile() threw the wrong exception where file entry did exist, but had a bad mapping");
            }
            ...
            {
                throw tc::TestException(
                    ".openFile() threw the wrong exception where file entry did exist, but stream was null");
            }
    ...
    try
    {
        try
        {
            try
            {
                ...
                // snapshot.dir_entries.push_back(dirC_entry);
                // snapshot.dir_entry_path_map.insert(std::pair<tc::io::Path, size_t>(dirC_entry.dir_listing.abs_path,
                // snapshot.dir_entries.size()-1));
                ...
                throw tc::TestException(".getDirectoryListing() did not throw tc::io::DirectoryNotFoundException where "
                                        "dir entry did not exist");
            }
            ...
            {
                throw tc::TestException(
                    ".getDirectoryListing() threw the wrong exception where dir entry did not exist");
            }
            ...
            try
            {
                ...
                throw tc::TestException(".getDirectoryListing() did not throw tc::io::DirectoryNotFoundException where "
                                        "dir entry did exist, but not mapped to a path");
            }
            catch (tc::io::DirectoryNotFoundException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(".getDirectoryListing() threw the wrong exception where dir entry did exist, "
                                        "but not mapped to a path");
            }
            ...
            try
            {
                ...
                snapshot.dir_entries.push_back(dirC_entry);
                snapshot.dir_entry_path_map.insert(
                    std::pair<tc::io::Path, size_t>(dirC_entry.dir_listing.abs_path, -1));
                ...
                throw tc::TestException(".getDirectoryListing() did not throw tc::io::DirectoryNotFoundException where "
                                        "dir entry did exist, but not mapped correctly.");
            }
            catch (tc::io::DirectoryNotFoundException &)
            { /* do nothing*/
            }
    ...
    try
    {
        try
        {
            try
            {
                ...
                throw tc::TestException(".setWorkingDirectory() did not throw tc::io::DirectoryNotFoundException where "
                                        "dir entry did not exist");
            }
            catch (tc::io::DirectoryNotFoundException &)
            { /* do nothing*/
            ...
            {
                throw tc::TestException(
                    ".setWorkingDirectory() threw the wrong exception where dir entry did not exist");
            }
            ...
            {
                throw tc::TestException(".setWorkingDirectory() threw the wrong exception where dir entry did exist, "
                                        "but not mapped to a path");
            }
    ...
    try
    {
        try
        {
            try
            {
                ...
                throw tc::TestException(".getCanonicalPath() did not throw tc::io::DirectoryNotFoundException where "
                                        "dir entry did not exist");
            }
            catch (tc::io::DirectoryNotFoundException &)
            { /* do nothing*/
            ...
            {
                throw tc::TestException(".getCanonicalPath() threw the wrong exception where dir entry did exist, but "
                                        "not mapped to a path");
            }
            ...
            try
            {
                ...
                // snapshot.file_entries.push_back(fileC_entry);
                // snapshot.file_entry_path_map.insert(std::pair<tc::io::Path,
                // size_t>(dirRoot_entry.dir_listing.abs_path + tc::io::Path("fileC"), snapshot.file_entries.size()-1));
            ...
            try
            {
                ...
                throw tc::TestException(".getCanonicalPath() did not throw tc::io::DirectoryNotFoundException where "
                                        "file entry did exist, but not mapped to a path");
            }
            catch (tc::io::DirectoryNotFoundException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(".getCanonicalPath() threw the wrong exception where file entry did exist, but "
                                        "not mapped to a path");
            }
            ...
            try
            {
                ...
                snapshot.file_entries.push_back(fileC_entry);
                snapshot.file_entry_path_map.insert(
                    std::pair<tc::io::Path, size_t>(dirRoot_entry.dir_listing.abs_path + tc::io::Path("fileC"), -1));
                ...
                throw tc::TestException(".getCanonicalPath() did not throw tc::io::DirectoryNotFoundException where "
                                        "file entry did exist, but not mapped correctly.");
            }
            catch (tc::io::DirectoryNotFoundException &)
            { /* do nothing*/
            }
...
void io_VirtualFileSystem_TestClass::test_WorksForAllValidPaths_OpenFile()
{
    ...
    try
    {
        try
        {
            ...
            fileD_entry.stream = std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0xD, true, false, true, false, false));
            ...
            snapshot.file_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                dirB_entry.dir_listing.abs_path + tc::io::Path("fileD"), snapshot.file_entries.size() - 1));
            ...
            try
            {
                ...
                std::shared_ptr<tc::io::IStream> stream;
                filesystem.openFile(
                    tc::io::Path(literal_path), tc::io::FileMode::Open, tc::io::FileAccess::Read, stream);

                if (stream == nullptr)
                {
                    throw tc::TestException(
                        fmt::format(".openFile() returned a null stream for file \"{:s}\".", literal_path));
                }

                if (stream->canRead() == false)
                {
                    throw tc::TestException(fmt::format(
                        ".openFile() returned a stream where canRead() was false for file \"{:s}\".", literal_path));
                }

                if (stream->canWrite() == true)
                {
                    throw tc::TestException(fmt::format(
                        ".openFile() returned a stream where canWrite() was true for file \"{:s}\".", literal_path));
                }
                ...
                {
                    throw tc::TestException(fmt::format(
                        ".openFile() returned a stream where length was 0x{:x} (expected 0x{:x}) for file \"{:s}\".",
                        actual_length, expected_length, literal_path));
                }
            }
            catch (tc::io::FileNotFoundException &)
            {
                throw tc::TestException(fmt::format(
                    ".openFile() threw tc::io::FileNotFoundException where file (\"{:s}\") did exist.", literal_path));
            }
            ...
            {
                throw tc::TestException(fmt::format(
                    ".openFile() threw tc::io::DirectoryNotFoundException where file (\"{:s}\") did exist.",
                    literal_path));
            }
    ...
    try
    {
        try
        {
            ...
            try
            {
                ...
                {
                    throw tc::TestException(fmt::format(
                        ".getDirectoryListing() did not return the correct DirectoryListing for directory \"{:s}\" "
                        "(wrong absolute path).",
                        literal_path));
                }
            ...
            {
                throw tc::TestException(fmt::format(
                    ".getDirectoryListing() threw tc::io::DirectoryNotFoundException where directory (\"{:s}\") did "
                    "exist.",
                    literal_path));
            }
...
void io_VirtualFileSystem_TestClass::test_WorksForAllValidPaths_SetWorkingDirectory()
{
    ...
    try
    {
        try
        {
            ...
            {
                throw tc::TestException(fmt::format(
                    ".setWorkingDirectory() threw tc::io::DirectoryNotFoundException where directory (\"{:s}\") did "
                    "exist.",
                    literal_path));
            }
        ...
        try
        {
            ...
            // test that working directory at point of filesystem creation is root
            {
                ...
                if (expected_working_directory != working_directory)
                {
                    ...
                    throw tc::TestException(fmt::format(
                        "getWorkingDirectory() returned a path that was not root after the filesystem was created. "
                        "(returned: \"{:s}\", expected: \"{:s}\")",
                        working_directory.to_string(), expected_working_directory.to_string()));
                }
            }
            ...
            literal_path = "/";
            {
                ...
                if (expected_working_directory != working_directory)
                {
                    ...
                    std::string working_directory_string;
                    throw tc::TestException(fmt::format(
                        "getWorkingDirectory() did not return the expected path. (returned: \"{:s}\", expected: "
                        "\"{:s}\")",
                        working_directory.to_string(), expected_working_directory.to_string()));
                }
            }
...
void io_VirtualFileSystem_TestClass::test_WorksForAllValidPaths_GetCanonicalPath()
{
    ...
    try
    {
        try
        {
            ...
            fileE_entry.stream = std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0xC, true, false, true, false, false));

            tc::io::VirtualFileSystem::FileSystemSnapshot::FileEntry fileF_entry;
            fileF_entry.stream = std::make_shared<StreamTestUtil::DummyStreamBase>(
                StreamTestUtil::DummyStreamBase(0xC, true, false, true, false, false));
            ...
            snapshot.dir_entry_path_map.insert(
                std::pair<tc::io::Path, size_t>(dirD_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));

            snapshot.dir_entries.push_back(dirE_entry);
            snapshot.dir_entry_path_map.insert(
                std::pair<tc::io::Path, size_t>(dirE_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));

            snapshot.dir_entries.push_back(dirF_entry);
            snapshot.dir_entry_path_map.insert(
                std::pair<tc::io::Path, size_t>(dirF_entry.dir_listing.abs_path, snapshot.dir_entries.size() - 1));
            ...
            snapshot.file_entries.push_back(fileD_entry);
            snapshot.file_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                dirA_entry.dir_listing.abs_path + tc::io::Path("fileD"), snapshot.file_entries.size() - 1));

            snapshot.file_entries.push_back(fileE_entry);
            snapshot.file_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                dirB_entry.dir_listing.abs_path + tc::io::Path("fileE"), snapshot.file_entries.size() - 1));

            snapshot.file_entries.push_back(fileF_entry);
            snapshot.file_entry_path_map.insert(std::pair<tc::io::Path, size_t>(
                dirC_entry.dir_listing.abs_path + tc::io::Path("fileF"), snapshot.file_entries.size() - 1));

            // create filesystem
            auto filesystem = tc::io::VirtualFileSystem(snapshot);

            // create tests (they do not have to be too comprehensive as getCanonicalPath() is *mostly a wrapper for the
            // IPathResolver used)
            ...
            for (auto itr = canonical_path_tests.begin(); itr != canonical_path_tests.end(); itr++)
            {
                try
                {
                    ...
                    {
                        throw tc::TestException(fmt::format(
                            ".getCanonicalPath() Incorrectly translated \"{:s}\" to \"{:s}\" (expected: \"{:s}\")",
                            itr->in_path.to_string(), canonised_path.to_string(), itr->out_path.to_string()));
                    }
                }
                catch (tc::Exception &e)
                {
                    throw tc::TestException(fmt::format(
                        ".getCanonicalPath() Failed to translate \"{:s}\" to \"{:s}\" ({:s})", itr->in_path.to_string(),
                        itr->out_path.to_string(), e.error()));
                }
            }
    ...
    try
    {
        try
        {
            ...
            try
            {
                filesystem.createFile(tc::io::Path());
                throw tc::TestException(
                    ".createFile() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                filesystem.removeFile(tc::io::Path());
                throw tc::TestException(
                    ".removeFile() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                ...
                filesystem.openFile(file_path, tc::io::FileMode::Open, tc::io::FileAccess::Read, file_stream);
                throw tc::TestException(
                    ".openFile() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                filesystem.createDirectory(tc::io::Path());
                throw tc::TestException(
                    ".createDirectory() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                filesystem.createDirectoryPath(tc::io::Path());
                throw tc::TestException(
                    ".createDirectoryPath() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".createDirectoryPath() threw the wrong exception for disposed VirtualFileSystem");
            }
            ...
            try
            {
                filesystem.removeDirectory(tc::io::Path());
                throw tc::TestException(
                    ".removeDirectory() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                ...
                filesystem.getCanonicalPath(tc::io::Path(), tmp_path);
                throw tc::TestException(
                    ".getCanonicalPath() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            try
            {
                ...
                filesystem.getWorkingDirectory(path);
                throw tc::TestException(
                    ".getWorkingDirectory() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".getWorkingDirectory() threw the wrong exception for disposed VirtualFileSystem");
            }
            ...
            try
            {
                filesystem.setWorkingDirectory(tc::io::Path());
                throw tc::TestException(
                    ".setWorkingDirectory() did not throw tc::ObjectDisposedException for disposed VirtualFileSystem");
            }
            catch (tc::ObjectDisposedException &)
            { /* do nothing*/
            }
            ...
            {
                throw tc::TestException(
                    ".setWorkingDirectory() threw the wrong exception for disposed VirtualFileSystem");
            }
