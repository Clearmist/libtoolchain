...
crypto_Rsa2048OaepSha2512Encryptor_TestClass::crypto_Rsa2048OaepSha2512Encryptor_TestClass()
    : mTestTag("tc::crypto::Rsa2048OaepSha2512Encryptor"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Rsa2048OaepSha2512Encryptor::kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d}", tc::crypto::Rsa2048OaepSha2512Encryptor::kBlockSize,
                kExpectedBlockSize));
        }
...
void crypto_Rsa2048OaepSha2512Encryptor_TestClass::test_UseUtilFuncDec()
{
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test decryption
            size_t message_size = 0;
            bool res = tc::crypto::DecryptRsa2048OaepSha2512(
            ...
            {
                throw tc::TestException(fmt::format(
                    "Test \"{:s}\" Failed: DecryptRsa2048OaepSha2512 returned {} (expected {})", test->test_name, res,
                    true));
            }
            if (message_size != test->dec_message.size())
            {
...
void crypto_Rsa2048OaepSha2512Encryptor_TestClass::test_UseUtilFuncEnc()
{
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test encryption
            bool res = tc::crypto::EncryptRsa2048OaepSha2512(
            ...
            {
                throw tc::TestException(fmt::format(
                    "Test \"{:s}\" Failed: EncryptRsa2048OaepSha2512 returned {} (expected {})", test->test_name, res,
                    true));
            }

            // try to decrypt message
            size_t message_size = 0;
            res = tc::crypto::DecryptRsa2048OaepSha2512(
...
void crypto_Rsa2048OaepSha2512Encryptor_TestClass::test_DoesNothingWhenNotInit()
{
    ...
    try
    {
        ...
        tc::ByteData control_block = tc::io::PaddingSource(0xdd, tc::crypto::Rsa2048OaepSha2512Encryptor::kBlockSize)
                                         .pullData(0, tc::crypto::Rsa2048OaepSha2512Encryptor::kBlockSize);
...
void crypto_Rsa2048OaepSha2512Encryptor_TestClass::test_EncryptReturnsFalseOnBadInput()
{
    ...
    try
    {
        ...
        size_t max_message_size =
            tc::crypto::Rsa2048OaepSha2512Encryptor::kBlockSize - (2 * tc::crypto::Sha2512Generator::kHashSize) - 2;
        result = cryptor.encrypt(
