...
crypto_Rsa1024OaepSha2256Encryptor_TestClass::crypto_Rsa1024OaepSha2256Encryptor_TestClass()
    : mTestTag("tc::crypto::Rsa1024OaepSha2256Encryptor"), mTestResults()
{
}

void crypto_Rsa1024OaepSha2256Encryptor_TestClass::runAllTests(void)
{
    test_Constants();
    test_UseClassDec();
    test_UseClassEnc();
...
const std::string &crypto_Rsa1024OaepSha2256Encryptor_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &crypto_Rsa1024OaepSha2256Encryptor_TestClass::getTestResults() const
{
    return mTestResults;
}
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_Constants()
{
    ...
    try
    {
        ...
        if (tc::crypto::Rsa1024OaepSha2256Encryptor::kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d}", tc::crypto::Rsa1024OaepSha2256Encryptor::kBlockSize,
                kExpectedBlockSize));
        }
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_UseClassDec()
{
    TestResult test_result;
    ...
    try
    {
        ...
        tc::crypto::Rsa1024OaepSha2256Encryptor cryptor;
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_UseClassEnc()
{
    TestResult test_result;
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_UseUtilFuncDec()
{
    TestResult test_result;
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test decryption
            size_t message_size = 0;
            bool res = tc::crypto::DecryptRsa1024OaepSha2256(
            ...
            {
                throw tc::TestException(fmt::format(
                    "Test \"{:s}\" Failed: DecryptRsa1024OaepSha2256 returned {} (expected {})", test->test_name, res,
                    true));
            }
            if (message_size != test->dec_message.size())
            {
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_UseUtilFuncEnc()
{
    TestResult test_result;
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test encryption
            bool res = tc::crypto::EncryptRsa1024OaepSha2256(
            ...
            {
                throw tc::TestException(fmt::format(
                    "Test \"{:s}\" Failed: EncryptRsa1024OaepSha2256 returned {} (expected {})", test->test_name, res,
                    true));
            }

            // try to decrypt message
            size_t message_size = 0;
            res = tc::crypto::DecryptRsa1024OaepSha2256(
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_UnspecifiedSeedProducesDifferentBlock()
{
    TestResult test_result;
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_DoesNothingWhenNotInit()
{
    TestResult test_result;
    ...
    try
    {
        ...
        tc::ByteData control_block = tc::io::PaddingSource(0xdd, tc::crypto::Rsa1024OaepSha2256Encryptor::kBlockSize)
                                         .pullData(0, tc::crypto::Rsa1024OaepSha2256Encryptor::kBlockSize);
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_InitializeThrowsExceptionOnBadInput()
{
    TestResult test_result;
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_EncryptReturnsFalseOnBadInput()
{
    TestResult test_result;
    ...
    try
    {
        ...
        size_t max_message_size =
            tc::crypto::Rsa1024OaepSha2256Encryptor::kBlockSize - (2 * tc::crypto::Sha2256Generator::kHashSize) - 2;
        result = cryptor.encrypt(
...
void crypto_Rsa1024OaepSha2256Encryptor_TestClass::test_DecryptReturnsFalseOnBadInput()
{
    TestResult test_result;
