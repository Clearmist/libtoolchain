...
crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::crypto_Rsa1024Pkcs1Sha2256Signer_TestClass()
    : mTestTag("tc::crypto::Rsa1024Pkcs1Sha2256Signer"), mTestResults()
{
}

void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::runAllTests(void)
{
    test_Constants();
    test_UseClassSign();
    test_UseClassVerify();
...
const std::string &crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::getTestResults() const
{
    return mTestResults;
}
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_Constants()
{
    ...
    try
    {
        ...
        if (tc::crypto::Rsa1024Pkcs1Sha2256Signer::kSignatureSize != kExpectedSignatureSize)
        {
            throw tc::TestException(fmt::format(
                "kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa1024Pkcs1Sha2256Signer::kSignatureSize,
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_UseClassSign()
{
    TestResult test_result;
    ...
    try
    {
        ...
        tc::crypto::Rsa1024Pkcs1Sha2256Signer signer;
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_UseClassVerify()
{
    TestResult test_result;
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_UseUtilFuncSign()
{
    TestResult test_result;
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test sign
            bool result = tc::crypto::SignRsa1024Pkcs1Sha2256(
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_UseUtilFuncVerify()
{
    TestResult test_result;
    ...
    try
    {
        ...
        {
            // test verify
            bool result = tc::crypto::VerifyRsa1024Pkcs1Sha2256(
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_DoesNothingWhenNotInit()
{
    TestResult test_result;
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_InitializeThrowsExceptionOnBadInput()
{
    TestResult test_result;
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_SignReturnsFalseOnBadInput()
{
    TestResult test_result;
...
void crypto_Rsa1024Pkcs1Sha2256Signer_TestClass::test_VerifyReturnsFalseOnBadInput()
{
    TestResult test_result;
