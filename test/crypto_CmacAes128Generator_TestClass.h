...
class crypto_CmacAes128Generator_TestClass : public ITestClass
{
  public:
    crypto_CmacAes128Generator_TestClass();
  ...
  private:
    ...
    void util_Setup_TestCases(std::vector<crypto_CmacAes128Generator_TestClass::TestCase> &test_cases);
};
