...
crypto_Rsa1024Pkcs1Md5Signer_TestClass::crypto_Rsa1024Pkcs1Md5Signer_TestClass()
    : mTestTag("tc::crypto::Rsa1024Pkcs1Md5Signer"), mTestResults()
{
}
...
const std::string &crypto_Rsa1024Pkcs1Md5Signer_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &crypto_Rsa1024Pkcs1Md5Signer_TestClass::getTestResults() const
{
    return mTestResults;
}
    ...
    try
    {
        ...
        if (tc::crypto::Rsa1024Pkcs1Md5Signer::kSignatureSize != kExpectedSignatureSize)
        {
            throw tc::TestException(fmt::format(
                "kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa1024Pkcs1Md5Signer::kSignatureSize,
...
void crypto_Rsa1024Pkcs1Md5Signer_TestClass::test_UseUtilFuncSign()
{
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test sign
            bool result = tc::crypto::SignRsa1024Pkcs1Md5(
...
void crypto_Rsa1024Pkcs1Md5Signer_TestClass::test_UseUtilFuncVerify()
{
    ...
    try
    {
        ...
        {
            // test verify
            bool result = tc::crypto::VerifyRsa1024Pkcs1Md5(
