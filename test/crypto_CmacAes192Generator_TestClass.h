...
class crypto_CmacAes192Generator_TestClass : public ITestClass
{
  public:
    crypto_CmacAes192Generator_TestClass();
  ...
  private:
    ...
    void util_Setup_TestCases(std::vector<crypto_CmacAes192Generator_TestClass::TestCase> &test_cases);
};
