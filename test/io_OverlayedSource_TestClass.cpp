...
io_OverlayedSource_TestClass::io_OverlayedSource_TestClass() : mTestTag("tc::io::OverlayedSource"), mTestResults() {}
...
void io_OverlayedSource_TestClass::testSingleOverlayConstructor()
{
    ...
    try
    {
        ...
        tc::io::OverlayedSource source(
            std::make_shared<tc::io::PaddingSource>(base_source),
            std::make_shared<tc::io::PaddingSource>(overlay_source), overlay_offset, overlay_source.length());
        ...
        pull_offset = 0;
        SourceTestUtil::pullTestHelper(
            source, pull_offset, pull_size, pull_size / 2, expected_data.data() + pull_offset);
...
void io_OverlayedSource_TestClass::testNullBaseStream()
{
    ...
    try
    {
        ...
        catch (tc::ArgumentNullException &)
        { /* do nothing */
        }
        catch (tc::Exception &)
        {
    ...
    try
    {
        try
        {
            ...
            throw tc::TestException(
                "Constructor did not throw tc::ArgumentNullException where an overlay source was null");
        }
        catch (tc::ArgumentNullException &)
        { /* do nothing */
        }
...
void io_OverlayedSource_TestClass::testOverlayStreamTooSmallForOverlayRegion()
{
    ...
    try
    {
        try
        {
            ...
            throw tc::TestException("Constructor did not throw tc::ArgumentOutOfRangeException where an overlay source "
                                    "was smaller than the region it was supposed to overlay");
        }
        catch (tc::ArgumentOutOfRangeException &)
        { /* do nothing */
        }
        catch (tc::Exception &)
        {
            throw tc::TestException("Constructor threw the wrong exception where an overlay source was smaller than "
                                    "the region it was supposed to overlay");
        }
...
void io_OverlayedSource_TestClass::testOverlayRegionBeforeBaseStream()
{
    ...
    try
    {
        try
        {
            ...
            tc::io::OverlayedSource source(
                std::make_shared<tc::io::PaddingSource>(base_source),
                std::make_shared<tc::io::PaddingSource>(padding_source), -1, 1);

            throw tc::TestException("Constructor did not throw tc::ArgumentOutOfRangeException where the overlay "
                                    "region entirely doesn't exist in the base");
        }
        catch (tc::ArgumentOutOfRangeException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                "Constructor threw the wrong exception where the overlay region entirely doesn't exist in the base");
        }
...
void io_OverlayedSource_TestClass::testOverlayRegionPartlyBeforeBaseStream()
{
    ...
    try
    {
        try
        {
            ...
            tc::io::OverlayedSource source(
                std::make_shared<tc::io::PaddingSource>(base_source),
                std::make_shared<tc::io::PaddingSource>(padding_source), -1, 20);

            throw tc::TestException("Constructor did not throw tc::ArgumentOutOfRangeException where overlay region "
                                    "partly exists before in the base");
        }
        catch (tc::ArgumentOutOfRangeException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                "Constructor threw the wrong exception where overlay region partly exists before in the base");
        }
...
void io_OverlayedSource_TestClass::testOverlayRegionAfterBaseStream()
{
    ...
    try
    {
        try
        {
            ...
            tc::io::OverlayedSource source(
                std::make_shared<tc::io::PaddingSource>(base_source),
                std::make_shared<tc::io::PaddingSource>(padding_source), 0x1000, 0x100);

            throw tc::TestException("Constructor did not throw tc::ArgumentOutOfRangeException where overlay region "
                                    "exists after in the base");
        }
        catch (tc::ArgumentOutOfRangeException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                "Constructor threw the wrong exception where overlay region exists after in the base");
        }
...
void io_OverlayedSource_TestClass::testOverlayRegionPartlyAfterBaseStream()
{
    ...
    try
    {
        try
        {
            ...
            tc::io::OverlayedSource source(
                std::make_shared<tc::io::PaddingSource>(base_source),
                std::make_shared<tc::io::PaddingSource>(padding_source), 0xfff, 0x100);

            throw tc::TestException("Constructor did not throw tc::ArgumentOutOfRangeException where overlay region "
                                    "exists partly after in the base");
        }
        catch (tc::ArgumentOutOfRangeException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                "Constructor threw the wrong exception where overlay region exists partly after in the base");
        }
