...
crypto_Pbkdf1Md5KeyDeriver_TestClass::crypto_Pbkdf1Md5KeyDeriver_TestClass()
    : mTestTag("tc::crypto::Pbkdf1Md5KeyDeriver"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Pbkdf1Md5KeyDeriver::kMaxDerivableSize != kExpectedMaxDerivableSize)
        {
            throw tc::TestException(fmt::format(
                "kMaxDerivableSize had value {:d}  (expected {:d})", tc::crypto::Pbkdf1Md5KeyDeriver::kMaxDerivableSize,
                kExpectedMaxDerivableSize));
        }
...
void crypto_Pbkdf1Md5KeyDeriver_TestClass::test_WillThrowExceptionOnZeroRounds()
{
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException("DeriveKeyPbkdf1Md5() Did not throw tc::crypto::CryptoException where the round "
        ...
        catch (const tc::Exception &)
        {
            throw tc::TestException(
                "DeriveKeyPbkdf1Md5() Threw the wrong exception where the round count was set to zero.");
        }
        ...
        try
        {
            ...
            throw tc::TestException(
                "Pbkdf1Md5KeyDeriver::initialize() Did not throw exception where the round count was set to zero.");
        }
        catch (const tc::crypto::CryptoException &)
        { /* do nothing */
        }
        ...
        {
            throw tc::TestException(
                "Pbkdf1Md5KeyDeriver::initialize() Threw the wrong exception where the round count was set to zero.");
        }
...
void crypto_Pbkdf1Md5KeyDeriver_TestClass::test_WillThrowExceptionOnTooLargeDkSize()
{
    ...
    try
    {
        ...
        try
        {
            ...
            throw tc::TestException("DeriveKeyPbkdf1Md5() Did not throw tc::crypto::CryptoException where the derived "
        ...
        {
            throw tc::TestException("DeriveKeyPbkdf1Md5() Threw the wrong exception where the derived data length "
        ...
        try
        {
            ...
            throw tc::TestException("Pbkdf1Md5KeyDeriver::getBytes() Did not throw tc::crypto::CryptoException where "
        ...
        {
            throw tc::TestException("Pbkdf1Md5KeyDeriver::getBytes() Threw the wrong exception where the derived data "
