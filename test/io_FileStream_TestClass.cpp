...
std::string io_FileStream_TestClass::kRandomString =
    "uUkMx4MYhJdwUnr38Jk7nZvXQnW0IhGNQqjMRyKoRuxXwmxBS3p2Alzrv7BijPN2LDI1QGkEfQ3vrpoOGwKciwidTyuOPRRg9sj8QggPk7QSvJrrWK"
    "N3PfzN7JvEwax3vX3QaHIoX0afJtUiulzVf9SMlotimwrdOHbeAhLzQUSCAz6moIHhZd6DO0hFxjCxGpHUnDKE";

//---------------------------------------------------------

io_FileStream_TestClass::io_FileStream_TestClass() : mTestTag("tc::io::FileStream"), mTestResults() {}
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Constructor with invalid arg combination (FileMode::CreateNew & "
                                        "FileAccess::Read) did not throw tc::ArgumentException");
            }
            ...
            {
                throw tc::TestException("Constructor with invalid arg combination (FileMode::CreateNew & "
                                        "FileAccess::Read) threw the wrong exception");
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Constructor when supplied invalid arg combination (FileMode::CreateNew & "
                                        "FileAccess::Read) did not throw tc::ArgumentException");
            }
            catch (const tc::ArgumentException &)
            { /* do nothing */
...
void io_FileStream_TestClass::test_Constructor_CreateNew_Write_FileExists()
{
    ...
    try
    {
        ...
        try
        {
            ...
            {
                auto stream =
                    tc::io::FileStream(kAsciiFilePath, tc::io::FileMode::CreateNew, tc::io::FileAccess::Write);

                StreamTestUtil::constructor_TestHelper(stream, 0, 0, false, true, true);

                throw tc::TestException("Attempting to (FileMode::CreateNew,FileAccess::Write) when the file already "
                                        "exists did not throw tc::io::FileExistsException");
            }
            catch (const tc::io::FileExistsException &)
            { /* do nothing */
            }
            catch (const tc::Exception &)
            {
                throw tc::TestException("Attempting to (FileMode::CreateNew,FileAccess::Write) when the file already "
                                        "exists threw the wrong exception");
            }
...
void io_FileStream_TestClass::test_Constructor_CreateNew_ReadWrite_FileExists()
{
    ...
    try
    {
        ...
        try
        {
            ...
            {
                auto stream =
                    tc::io::FileStream(kAsciiFilePath, tc::io::FileMode::CreateNew, tc::io::FileAccess::ReadWrite);

                StreamTestUtil::constructor_TestHelper(stream, 0, 0, true, true, true);

                throw tc::TestException("Attempting to (FileMode::CreateNew,FileAccess::ReadWrite) when the file "
                                        "already exists did not throw tc::io::FileExistsException");
            }
            catch (const tc::io::FileExistsException &)
            { /* do nothing */
            }
            ...
            {
                throw tc::TestException("Attempting to (FileMode::CreateNew,FileAccess::ReadWrite) when the file "
                                        "already exists threw the wrong exception");
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Constructor with invalid arg combination (FileMode::Create & "
                                        "FileAccess::Read) did not throw tc::ArgumentException");
            }
            catch (const tc::ArgumentException &)
            { /* do nothing */
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Attempting to (FileMode::Open,FileAccess::Read) when the file does not exist "
                                        "did not throw tc::io::FileNotFoundException");
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Attempting to (FileMode::Open,FileAccess::Write) when the file does not exist "
                                        "did not throw tc::io::FileNotFoundException");
            }
            catch (const tc::io::FileNotFoundException &)
            { /* do nothing */
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Attempting to (FileMode::Open,FileAccess::ReadWrite) when the file does not "
                                        "exist did not throw tc::io::FileNotFoundException");
            }
            catch (const tc::io::FileNotFoundException &)
            { /* do nothing */
            }
            ...
            {
                throw tc::TestException("Attempting to (FileMode::Open,FileAccess::ReadWrite) when the file does not "
                                        "exist threw the wrong exception");
            }
...
void io_FileStream_TestClass::test_Constructor_OpenOrCreate_Read_FileNotExist()
{
    ...
    try
    {
        ...
        try
        {
            ...
            {
                auto stream =
                    tc::io::FileStream(kAsciiFilePath, tc::io::FileMode::OpenOrCreate, tc::io::FileAccess::Read);

                StreamTestUtil::constructor_TestHelper(stream, 0, 0, true, false, true);

                throw tc::TestException("Attempting to (FileMode::OpenOrCreate,FileAccess::Read) when the file does "
                                        "not exist did not throw tc::io::FileNotFoundException");
            }
            catch (const tc::io::FileNotFoundException &)
            { /* do nothing */
            }
            ...
            {
                throw tc::TestException("Attempting to (FileMode::OpenOrCreate,FileAccess::Read) when the file does "
                                        "not exist threw the wrong exception");
            }
...
void io_FileStream_TestClass::test_Constructor_OpenOrCreate_ReadWrite_FileExists()
{
    ...
    try
    {
        ...
        {
            auto stream =
                tc::io::FileStream(kAsciiFilePath, tc::io::FileMode::OpenOrCreate, tc::io::FileAccess::ReadWrite);
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Constructor with invalid arg combination (FileMode::Truncate & "
                                        "FileAccess::Read) did not throw tc::ArgumentException");
            }
            catch (const tc::ArgumentException &)
            { /* do nothing */
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Attempting to (FileMode::Truncate,FileAccess::Write) when the file does not "
                                        "exist did not throw tc::io::FileNotFoundException");
            }
            catch (const tc::io::FileNotFoundException &)
            { /* do nothing */
...
void io_FileStream_TestClass::test_Constructor_Truncate_ReadWrite_FileNotExist()
{
    ...
    try
    {
        ...
        try
        {
            ...
            {
                auto stream =
                    tc::io::FileStream(kAsciiFilePath, tc::io::FileMode::Truncate, tc::io::FileAccess::ReadWrite);

                StreamTestUtil::constructor_TestHelper(stream, 0, 0, true, true, true);

                throw tc::TestException("Attempting to (FileMode::Truncate,FileAccess::ReadWrite) when the file does "
                                        "not exist did not throw tc::io::FileNotFoundException");
            }
            catch (const tc::io::FileNotFoundException &)
            { /* do nothing */
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Constructor with invalid arg combination (FileMode::Append & "
                                        "FileAccess::Read) did not throw tc::ArgumentException");
            }
            catch (const tc::ArgumentException &)
            { /* do nothing */
...
void io_FileStream_TestClass::test_Constructor_Append_Write_FileExists()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::constructor_TestHelper(
                stream, kRandomString.size(), kRandomString.size(), false, true, false);
...
void io_FileStream_TestClass::test_Constructor_Append_ReadWrite_FileExists()
{
    ...
    try
    {
        ...
        try
        {
            ...
            {
                auto stream =
                    tc::io::FileStream(kAsciiFilePath, tc::io::FileMode::Append, tc::io::FileAccess::ReadWrite);

                throw tc::TestException("Constructor with invalid arg combination (FileMode::Append & "
                                        "FileAccess::ReadWrite) did not throw tc::ArgumentException");
            }
            catch (const tc::ArgumentException &)
            { /* do nothing */
            }
            ...
            {
                throw tc::TestException("Constructor with invalid arg combination (FileMode::Append & "
                                        "FileAccess::ReadWrite) threw the wrong exception");
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Constructor with an unrecognised value for FileMode did not throw "
                                        "tc::ArgumentOutOfRangeException");
            }
            ...
            catch (const tc::Exception &)
            {
                throw tc::TestException(
                    "Constructor with an unrecognised value for FileMode threw the wrong exception");
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Constructor with an unrecognised value for FileAccess did not throw "
                                        "tc::ArgumentOutOfRangeException");
            }
            catch (const tc::ArgumentOutOfRangeException &)
            { /* do nothing */
            ...
            {
                throw tc::TestException(
                    "Constructor with an unrecognised value for FileAccess threw the wrong exception");
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException("Attempting to open a directory as a file did not throw tc::io::IOException or "
                                        "tc::UnauthorisedAccessException");
            }
            catch (const tc::io::IOException &)
            { /* do nothing */
            }
            catch (const tc::UnauthorisedAccessException &)
            { /* do nothing */
            }
            catch (const tc::Exception &)
            {
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException(
                    ".seek() when stream was opened in FileMode::Append did not throw tc::io::IOException");
            }
            catch (const tc::io::IOException &)
            { /* do nothing */
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                throw tc::TestException(".seek() when attempting to seek before the start of the file did not throw "
                                        "tc::ArgumentOutOfRangeException");
            }
            catch (const tc::ArgumentOutOfRangeException &)
            { /* do nothing */
            ...
            {
                throw tc::TestException(
                    ".seek() when attempting to seek before the start of the file threw the wrong exception");
            }
...
void io_FileStream_TestClass::test_Seek_PositionAfterFileEnd()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::seek_TestHelper(
                stream, stream.length(), tc::io::SeekOrigin::Begin, stream.length(), stream.length());
...
void io_FileStream_TestClass::test_Read_NoData()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::read_TestHelper(
                stream, stream.length() / 2, tc::io::SeekOrigin::Begin, kRandomString.size(), 0, 0,
                stream.length() / 2);
            StreamTestUtil::read_TestHelper(
                stream, 0, tc::io::SeekOrigin::End, kRandomString.size(), 0, 0, stream.length());
...
void io_FileStream_TestClass::test_Read_SomeDataFromZero()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::read_TestHelper(
                stream, 0, tc::io::SeekOrigin::Begin, kRandomString.size(), 0x01, 0x01, 0x01,
                (const byte_t *)kRandomString.c_str());
            StreamTestUtil::read_TestHelper(
                stream, 0, tc::io::SeekOrigin::Begin, kRandomString.size(), 0x20, 0x20, 0x20,
                (const byte_t *)kRandomString.c_str());
            StreamTestUtil::read_TestHelper(
                stream, 0, tc::io::SeekOrigin::Begin, kRandomString.size(), kRandomString.size() / 2,
                kRandomString.size() / 2, kRandomString.size() / 2, (const byte_t *)kRandomString.c_str());
...
void io_FileStream_TestClass::test_Read_SomeDataFromMiddle()
{
    ...
    try
    {
        ...
        try
        {
            ...
            size = 20;
            StreamTestUtil::read_TestHelper(
                stream, offset, tc::io::SeekOrigin::Begin, kRandomString.size(), size, size, offset + size,
                (const byte_t *)kRandomString.c_str() + offset);
...
void io_FileStream_TestClass::test_Read_AllData()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::read_TestHelper(
                stream, 0, tc::io::SeekOrigin::Begin, kRandomString.size(), kRandomString.size(), kRandomString.size(),
                kRandomString.size(), (const byte_t *)kRandomString.c_str());
...
void io_FileStream_TestClass::test_Read_TooMuchData()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::read_TestHelper(
                stream, 0, tc::io::SeekOrigin::Begin, kRandomString.size() * 2, kRandomString.size() * 2,
                kRandomString.size(), kRandomString.size(), (const byte_t *)kRandomString.c_str());
...
void io_FileStream_TestClass::test_Read_BeyondEnd()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::read_TestHelper(
                stream, 1, tc::io::SeekOrigin::End, kRandomString.size(), kRandomString.size(), 0,
                kRandomString.size() + 1, (const byte_t *)kRandomString.c_str());
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                StreamTestUtil::read_TestHelper(
                    stream, 0, tc::io::SeekOrigin::Begin, kRandomString.size(), kRandomString.size(), 0,
                    kRandomString.size(), (const byte_t *)kRandomString.c_str());

                throw tc::TestException(
                    "Using .read() on a file with no read permissions did not throw tc::NotSupportedException");
            }
...
void io_FileStream_TestClass::test_Write_NoData()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::write_TestHelper(
                stream, 0, tc::io::SeekOrigin::Begin, (const byte_t *)kRandomString.c_str(), 0, 0);
...
void io_FileStream_TestClass::test_Write_OverwriteSomeDataFromZero()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::write_TestHelper(
                stream, written_data_offset, tc::io::SeekOrigin::Begin, written_data_ptr, written_data_size,
                written_data_offset + written_data_size);
            stream.dispose();

            auto expected_file_layout =
                tc::ByteData(std::max<size_t>(original_size, written_data_offset + written_data_size));
...
void io_FileStream_TestClass::test_Write_ExtendStreamSizeThruWritingDataFromZero()
{
    ...
    try
    {
        ...
        try
        {
            ...
            StreamTestUtil::write_TestHelper(
                stream, written_data_offset, tc::io::SeekOrigin::Begin, written_data_ptr, written_data_size,
                written_data_offset + written_data_size, written_data_offset + written_data_size);
            stream.dispose();
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                StreamTestUtil::write_TestHelper(
                    stream, 0, tc::io::SeekOrigin::Begin, (const byte_t *)kRandomString.c_str(), kRandomString.size(),
                    kRandomString.size());

                throw tc::TestException(
                    "Using .write() on a file with no write permissions did not throw tc::NotSupportedException");
            }
            catch (const tc::NotSupportedException &)
            { /* do nothing */
            }
    ...
    try
    {
        ...
        try
        {
            try
            {
                ...
                StreamTestUtil::write_TestHelper(
                    stream, 0, tc::io::SeekOrigin::Begin, nullptr, kRandomString.size(), kRandomString.size());
