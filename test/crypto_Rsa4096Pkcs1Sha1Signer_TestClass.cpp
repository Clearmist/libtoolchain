...
crypto_Rsa4096Pkcs1Sha1Signer_TestClass::crypto_Rsa4096Pkcs1Sha1Signer_TestClass()
    : mTestTag("tc::crypto::Rsa4096Pkcs1Sha1Signer"), mTestResults()
{
}
...
const std::string &crypto_Rsa4096Pkcs1Sha1Signer_TestClass::getTestTag() const
{
    return mTestTag;
}

const std::vector<ITestClass::TestResult> &crypto_Rsa4096Pkcs1Sha1Signer_TestClass::getTestResults() const
{
    return mTestResults;
}
    ...
    try
    {
        ...
        if (tc::crypto::Rsa4096Pkcs1Sha1Signer::kSignatureSize != kExpectedSignatureSize)
        {
            throw tc::TestException(fmt::format(
                "kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa4096Pkcs1Sha1Signer::kSignatureSize,
...
void crypto_Rsa4096Pkcs1Sha1Signer_TestClass::test_UseUtilFuncSign()
{
    ...
    try
    {
        ...
        for (auto test = tests.begin(); test != tests.end(); test++)
        {
            ...
            // test sign
            bool result = tc::crypto::SignRsa4096Pkcs1Sha1(
...
void crypto_Rsa4096Pkcs1Sha1Signer_TestClass::test_UseUtilFuncVerify()
{
    ...
    try
    {
        ...
        {
            // test verify
            bool result = tc::crypto::VerifyRsa4096Pkcs1Sha1(
