...
crypto_Tdes112EcbEncryptor_TestClass::crypto_Tdes112EcbEncryptor_TestClass()
    : mTestTag("tc::crypto::Tdes112EcbEncryptor"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Tdes112EcbEncryptor::kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::Tdes112EcbEncryptor::kBlockSize,
                kExpectedBlockSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kKeySize had value {:d} (expected {:d})", tc::crypto::Tdes112EcbEncryptor::kKeySize,
                kExpectedKeySize));
        }
...
void crypto_Tdes112EcbEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
    ...
    try
    {
        ...
        // create data
        tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Tdes112EcbEncryptor::kBlockSize)
                                        .pullData(0, tc::crypto::Tdes112EcbEncryptor::kBlockSize);
