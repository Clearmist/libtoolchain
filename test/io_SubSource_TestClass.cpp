...
io_SubSource_TestClass::io_SubSource_TestClass() : mTestTag("tc::io::SubSource"), mTestResults() {}
...
void io_SubSource_TestClass::testCreateConstructor()
{
    ...
    try
    {
        ...
        tc::io::OverlayedSource base_source = tc::io::OverlayedSource(
            std::shared_ptr<tc::io::PaddingSource>(new tc::io::PaddingSource(0, 0x10000)),
            std::make_shared<tc::io::PaddingSource>(expected_subsource), sub_offset, sub_length);
        tc::io::SubSource source =
            tc::io::SubSource(std::make_shared<tc::io::OverlayedSource>(base_source), sub_offset, sub_length);
