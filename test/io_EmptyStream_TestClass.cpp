...
io_EmptyStream_TestClass::io_EmptyStream_TestClass() : mTestTag("tc::io::EmptyStream"), mTestResults() {}
    ...
    try
    {
        ...
        catch (const tc::Exception &e)
        {
            throw tc::TestException(
                fmt::format(".seek() with invalid SeekOrigin threw the wrong exception ({:s})", e.what()));
        }
