...
bn_endian_TestClass::bn_endian_TestClass() : mTestTag("tc::bn endian_types"), mTestResults() {}
    ...
    try
    {
        ...
        if (swap_ret != x_inv)
        {
            throw tc::TestException(fmt::format(
                "tc::bn::detail::__local_bswap16(uint16_t) returned 0x{:x} (expected: 0x{:x}", swap_ret, x_inv));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::detail::__local_bswap16(void*) transformed 0x{:x} -> 0x{:x} (expected: 0x{:x}", x, x_test,
                x_inv));
        }
...
void bn_endian_TestClass::testLocalBSwap32()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::detail::__local_bswap32(uint32_t) returned 0x{:x} (expected: 0x{:x}", swap_ret, x_inv));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::detail::__local_bswap32(void*) transformed 0x{:x} -> 0x{:x} (expected: 0x{:x}", x, x_test,
                x_inv));
        }
...
void bn_endian_TestClass::testLocalBSwap64()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::detail::__local_bswap64(uint64_t) returned 0x{:x} (expected: 0x{:x}", swap_ret, x_inv));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::detail::__local_bswap64(void*) transformed 0x{:x} -> 0x{:x} (expected: 0x{:x}", x, x_test,
                x_inv));
        }
    ...
    try
    {
        ...
        if (x_ret != x_expected)
        {
            throw tc::TestException(
                fmt::format("transformed 0x{:x} -> 0x{:x} (expected 0x{:x})", *x_raw_ptr, x_ret, x_expected));
        }
...
void bn_endian_TestClass::testBeSwap64Inline()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(
                fmt::format("transformed 0x{:x} -> 0x{:x} (expected 0x{:x})", x_before, x_after, x_expected));
        }
...
void bn_endian_TestClass::testBe64TemplateClass()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be64<uint64_t>::unwrap() returned 0x{:x} (expected 0x{:x}", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be64<uint64_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})", 0,
                unwrap_ret, 0));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be64<uint64_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                x_expected, unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be64<uint64_t> implicit unwrap returned 0x{:x} (expected 0x{:x})", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be64<uint64_t> implicit wrap failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                0x0, unwrap_ret, 0x0));
        }
...
void bn_endian_TestClass::testBe32TemplateClass()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be32<uint32_t>::unwrap() returned 0x{:x} (expected 0x{:x}", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be32<uint32_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})", 0,
                unwrap_ret, 0));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be32<uint32_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                x_expected, unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be32<uint32_t> implicit unwrap returned 0x{:x} (expected 0x{:x})", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be32<uint32_t> implicit wrap failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                0x0, unwrap_ret, 0x0));
        }
...
void bn_endian_TestClass::testBe16TemplateClass()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be16<uint16_t>::unwrap() returned 0x{:x} (expected 0x{:x}", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be16<uint16_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})", 0,
                unwrap_ret, 0));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be16<uint16_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                x_expected, unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be16<uint16_t> implicit unwrap returned 0x{:x} (expected 0x{:x})", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::be16<uint16_t> implicit wrap failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                0x0, unwrap_ret, 0x0));
        }
...
void bn_endian_TestClass::testLe64TemplateClass()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le64<uint64_t>::unwrap() returned 0x{:x} (expected 0x{:x}", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le64<uint64_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})", 0,
                unwrap_ret, 0));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le64<uint64_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                x_expected, unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le64<uint64_t> implicit unwrap returned 0x{:x} (expected 0x{:x})", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le64<uint64_t> implicit wrap failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                0x0, unwrap_ret, 0x0));
        }
...
void bn_endian_TestClass::testLe32TemplateClass()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le32<uint32_t>::unwrap() returned 0x{:x} (expected 0x{:x}", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le32<uint32_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})", 0,
                unwrap_ret, 0));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le32<uint32_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                x_expected, unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le32<uint32_t> implicit unwrap returned 0x{:x} (expected 0x{:x})", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le32<uint32_t> implicit wrap failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                0x0, unwrap_ret, 0x0));
        }
...
void bn_endian_TestClass::testLe16TemplateClass()
{
    ...
    try
    {
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le16<uint16_t>::unwrap() returned 0x{:x} (expected 0x{:x}", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le16<uint16_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})", 0,
                unwrap_ret, 0));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le16<uint16_t>::wrap() failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                x_expected, unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le16<uint16_t> implicit unwrap returned 0x{:x} (expected 0x{:x})", unwrap_ret, x_expected));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "tc::bn::le16<uint16_t> implicit wrap failed to wrap 0x{:x} (unwrap returned 0x{:x}, expected 0x{:x})",
                0x0, unwrap_ret, 0x0));
        }
