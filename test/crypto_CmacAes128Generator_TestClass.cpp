...
crypto_CmacAes128Generator_TestClass::crypto_CmacAes128Generator_TestClass()
    : mTestTag("tc::crypto::CmacAes128Generator"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::CmacAes128Generator::kMacSize != kExpectedMacSize)
        {
            throw tc::TestException(fmt::format(
                "kMacSize had value {:d} (expected {:d})", tc::crypto::CmacAes128Generator::kMacSize,
                kExpectedMacSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::CmacAes128Generator::kBlockSize,
                kExpectedBlockSize));
        }
...
void crypto_CmacAes128Generator_TestClass::test_UtilFunc()
{
    ...
    try
    {
        ...
        {
            memset(mac.data(), 0xff, mac.size());
            tc::crypto::GenerateCmacAes128Mac(
...
void crypto_CmacAes128Generator_TestClass::util_Setup_TestCases(
    std::vector<crypto_CmacAes128Generator_TestClass::TestCase> &test_cases)
{
    TestCase tmp;
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("020683e1f0392f4cac54318b6029259e9c553dbc4b6ad998e64d58e4e7dc2e13");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("02749f4f9ad82fa7ba41d935a6f1aa6376b30b8775b6445ac89b3eac50cd8d56");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("992c3e5613ff420fd91be878d0e1d62e71f5f1106f5023f399915c980394d6db");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("25560cfd1e4cc153fe483bdac80dc11012adaa3d144d1456ff2cd92190e2bf9a");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("9d66d2ab77fed672e3af1fc4a77cb2610cd54ce3d7bdf6ff7b2cd8088db252b4");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("7cc7cb01cc966c3ef8a5bd0c911be24cfc919a150d5d730fd8173a1cc356b63e");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("43e1f6daf8b1f8becde9676b1565403bd4e3d8821809cab88caa34da4a45230d");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("1b4e4c7f91c698bfa7470fad1d6092fcefed1d022a9a415effa2d4dd16dde79f");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("4981c51fcc0935f619ec6bf862683b0025cc48724839bc1e67aa3c686d321ba6");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("f268c7d4df159ef4d284be92429b80726ef134734eebb9ccc9254c9628139e8b");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("5d44bac1a388eb81b0c3571f6d0566b69bdef5ff21664b73a4804eb05960f61e");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("62e97075c81ce3367a652b38268c7f27d837788812b3c59d1ef12188a3cf82b2");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("f799876d19ac1b849a1a43fe9912bcaf6e1e3896ea58bcb2dfdc4716e379b440");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("e12ca51c429ed7343367e509f692448ad31a923268f2842e414820bea80b2cdd");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("314e0c7d5c9afb7c4282bc132bf805749554614c865526eb2062a7a57616ac78");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("39fb12288a67f15fa4191d597c834dc0a049a4fc6ca686b1810ca988730a6f33");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("f2783540c9e1706ee3e7a43e71833987bb72441c1e2eab58501c8bfaec07d6332a");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("1295c5bd2d076b187277a02d57912d2e9e2771903182600351f6cca7efb9e47d5a");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("b11a4c2155d379d1dfa3fcb432f65cc5acc487ca4b1d17871406d331b583792569");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("255312e95b96e3eb369e3adebd2f5b40835aa058c147271da732c855f4b44afac5");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("c1093518efd80245e3c42371f220b21f2034e6738fe02ef43e828190f01aefe169");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("cbc2bce02e45704c925f88105ef13236c768f5b3399239e2f9b00a3108cc191b4a");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("692e47f5701bb2569fd9dde7f8eb8d670c336be77865acdcb0bcf173fbec6c24bf");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("32579b66327335100d9bd236e37e3b0d681354784274a17cb2ef0af4775adb86ef");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("b4693a2aa11cf9a5442f08dfa718590feff8d38fdf15f8ee9d8ac541b93dd9b96b");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("80f3ea04e42d4cef334c04c7eaae86832faf52f2aa286b5a96360b60183d9527cf");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("8a782e7b7c2ea77f63ddaa8563ed90d3b57c8c2242a6dd00710448733d72c6df8a");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("2e4d583513c6b8f479f161b442b7eeb87988591e939462b5f53e350eb7cd47d6a8");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("cead1c5af16ca89bc0821775f8cba8c25620a03dfd27d6f1186f75f1c0bcfe4a20");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("825b192f69fb73b2716fb35e69d9c09006a8a2422ac7e4e065143c58bd146e71aa");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("3a871632f22818bfd717b00618572936f4ba57e57d9c7a609cd0663f56dbe13d4d");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("e2b4b6f9484402645c47809ed5a83a17b378cf85224174d9a097397162f18e8ff4");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "0549eaeca4f397247f1d259612e6867e7d788c71d03c5136864ad6d84f24eaf913a34e6933");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "4da6feba6d119b8850bed945f57adcd3c3e84f85d581553b95dac3ce8c258cae78fb7dc99f");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "512cd890e461adea7fceebe7a93067d20ed150ee75afc2b9f2da97715d1e81d802e256359a");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "eb2e7e32589486aa849437c8dbbd713b60d76fa34123f9f6afe4db23ec1d97f6a69d573c83");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "11c90809f9c53d2f77b56af0a42287ac6920e3d2921cceb824d496caf1a7b6e7690f4908b3");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "dc787b2386fcae8b8c6d0c9d0c092aaedadd31500d37846bbe5fa3900c82508963eff035ff");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "2e523e9d8a5532127ec63b220838f11b0f8a09e9a317c1e4872d7fececc1b4b88060076ba7");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "162ff9478ca06aebfc7f86afa9cdd743916563ebfd3adbdd56e015ea3a4ebc61cfe2473157");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "8ceddebd38f00406743a6756565ce762d3464435d50bd61b8de57fbe0b79df8f0c5cc66713");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "bb5de4bae58d8f49c48811aa31d99bd7877a0ec04de9bcf8157f73afa3feb8e0526950cbb4");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "2bed02a7404e47dec28c79c2ecceb740031291fd2cb978f580467263626313e01025a8ce79");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "60c6e63b0e4ddef24f990e652c9b75293ba8e4567bcc068380629ff1d0e111068cf924fd53");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "ae1009f03626fcb54bf98c32912f0f70bd398c709c3ed8bf5754fe4bf5f6e47521b32c672e");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "a0a64582eff002bb348d2798f67812102377c334544e3e065332318ddb80d7299eaf1c258c");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "5788f61e02304791b52f40057abb4e0446403ef3740253df72059679bb2a6e5e059a709cbb");
    ...
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "12a340ef015dc0a38625a4847eb6cac9cab9450548e9f96402756531a6a5bf9c37c146bb01");
