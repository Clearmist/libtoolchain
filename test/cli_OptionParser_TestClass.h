  ...
  private:
    ...
    class UnkOptionHandler : public tc::cli::OptionParser::IOptionHandler
    {
      public:
        ...
        UnkOptionHandler(ResultCode &external_result) : external_result(external_result) {}
    ...
    class TestOptionHandler : public tc::cli::OptionParser::IOptionHandler
    {
      public:
        ...
        TestOptionHandler(
            ResultCode &external_result,
            const std::string &opt_literal,
            const std::string &opt_regex,
            const std::string &expected_option,
            ...
            : mExternalResult(external_result),
              ...
              mExpectedOption(expected_option), mExpectedParams(expected_params)
        {
        }
