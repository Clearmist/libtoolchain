...
crypto_HmacSha1Generator_TestClass::crypto_HmacSha1Generator_TestClass()
    : mTestTag("tc::crypto::HmacSha1Generator"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::HmacSha1Generator::kMacSize != kExpectedMacSize)
        {
            throw tc::TestException(fmt::format(
                "kMacSize had value {:d} (expected {:d})", tc::crypto::HmacSha1Generator::kMacSize, kExpectedMacSize));
        }
        ...
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::HmacSha1Generator::kBlockSize,
                kExpectedBlockSize));
        }
...
void crypto_HmacSha1Generator_TestClass::util_Setup_Rfc2202_TestCases(
    std::vector<crypto_HmacSha1Generator_TestClass::TestCase> &test_cases)
{
    TestCase tmp;
    ...
    tmp.in_key = tc::cli::FormatUtil::hexStringToBytes(
        ...
        "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"); // 80 x 0xaa
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
    ...
    tmp.in_key = tc::cli::FormatUtil::hexStringToBytes(
        ...
        "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"); // 80 x 0xaa
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "54657374205573696e67204c6172676572205468616e20426c6f636b2d53697a65204b657920616e64204c6172676572205468616e204f"
        "6e6520426c6f636b2d53697a652044617461"); // "Test Using Larger Than Block-Size Key and Larger Than One
                                                 // Block-Size Data"
