...
crypto_Tdes112CbcEncryptor_TestClass::crypto_Tdes112CbcEncryptor_TestClass()
    : mTestTag("tc::crypto::Tdes112CbcEncryptor"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (tc::crypto::Tdes112CbcEncryptor::kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(fmt::format(
                "kBlockSize had value {:d} (expected {:d})", tc::crypto::Tdes112CbcEncryptor::kBlockSize,
                kExpectedBlockSize));
        }
...
void crypto_Tdes112CbcEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
    ...
    try
    {
        ...
        // create data
        tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Tdes112CbcEncryptor::kBlockSize)
                                        .pullData(0, tc::crypto::Tdes112CbcEncryptor::kBlockSize);
...
void crypto_Tdes112CbcEncryptor_TestClass::test_InitializeThrowsExceptionOnBadInput()
{
    ...
    try
    {
        ...
        {
            cryptor.initialize(
                tests[0].key.data(), tc::crypto::Tdes112CbcEncryptor::kKeySize - 1, tests[0].iv.data(),
                tests[0].iv.size());
        ...
        try
        {
            cryptor.initialize(
                ...
                tc::crypto::Tdes112CbcEncryptor::kBlockSize - 1);
