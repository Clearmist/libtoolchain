...
crypto_CmacTdes168Generator_TestClass::crypto_CmacTdes168Generator_TestClass()
    : mTestTag("tc::crypto::CmacTdes168Generator"), mTestResults()
{
}
    ...
    try
    {
        ...
        if (kBlockSize != kExpectedBlockSize)
        {
            throw tc::TestException(
                fmt::format("kBlockSize had value {:d} (expected {:d})", kBlockSize, kExpectedBlockSize));
        }
...
void crypto_CmacTdes168Generator_TestClass::test_UtilFunc()
{
    ...
    try
    {
        ...
        {
            memset(mac.data(), 0xff, mac.size());
            tc::crypto::GenerateCmacTdes168Mac(
...
void crypto_CmacTdes168Generator_TestClass::util_Setup_TestCases(
    std::vector<crypto_CmacTdes168Generator_TestClass::TestCase> &test_cases)
{
    TestCase tmp;
    ...
    tmp.out_mac =
        tc::cli::FormatUtil::hexStringToBytes("8E8F293136283797"); // test data incorrectly had this as b7a688e122ffaf95
    test_cases.push_back(tmp);
    ...
    tmp.out_mac =
        tc::cli::FormatUtil::hexStringToBytes("743DDBE0CE2DC2ED"); // test data incorrectly had this as d32bcebe43d23d80
    test_cases.push_back(tmp);

    tmp.test_name = "NIST 800-38B Test 4";
    tmp.in_key = tc::cli::FormatUtil::hexStringToBytes("8aa83bf8cbda10620bc1bf19fbb6cd58bc313d4a371ca8b5");
    tmp.in_data = tc::cli::FormatUtil::hexStringToBytes(
        "6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e51"); // Mlen 256-bit
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("e43bd49c3976afa78a7138ddabfa132a72e7d1a422b40a582a6dac4a10ce92b7");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("9b758bc93d482505b1b7b6f147203a72e81bf19004a5fac1cb7e236aa0cf00a3");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("f6dd2c64bf597e63263ccae1c54e0805fef6588284aba0b11dac77e3a7f142f5");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("08711c9b08b1db1f7c9994e0b0d68d22abe79d68b08ad88b0b746f0a0a45d1a1");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("44690e968747c3c83c8816c69c989a66781246531d1d78037afb39ea85dfc3ee");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("4b8ffb7f4bd1ad42b6b5d392bfed6e3e8869b8634dc000eae0d1b45255aac0af");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("aba045f579e3b9258431bd930c5f1fe3f942b5a66520fb745a65fd3bdd9778d6");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("44d91d3d465a4111462ba0c7ec223da6735f4f5200453cf132c3c58dfad87eb9");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("993dacbc221ed32a6fb3d90559c674fb68089eea8df9eaec14071991d4fae86b");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("fa620c1bbe97319e9a0cf0492121f7a20eb08a6a709dcbd00aaf38e4f99e754e");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("1f3aa619ccff2f3590aa8a4d0f1da4eabad4970ca36a20cc8f5f53404d188d9f");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("bedf10354f5282bb635ec7f1f16faa4a2844fd17a7507808f060c4ef1a7fd2c8");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("6101be5dec2d0c365747ec4e26d3a0704a0d41e0457f03908ed2ba9637e59dde");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("68b0bd1cddb1e08180894f90823c4e8ce4548d737ed7508e4676cd46cf07d539");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("185577b48237acbdaa3590b8057fe374f875ce829b62c98fbd67bcf128b5647f");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("50f6e6dd57bd3a24f6bfdc8b1c7b5a36ebdd07fd6d194e6e82da47151d9c88fb");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("75559898f4ba03c55afc25ea91aa61a93c2f8270a5fa51b6f6dc6881adb1412c");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("f969ec9dd28ac983e156c0d298837a1e8973a6e784c141cbff1a14f9bb4e7ee9");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("9f07e6b7ea8b6d2bb301d6ce7019e0f27ad55abbb799e6d47681fe609af63434");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("991ad7d6667e932d010d00d0951bb7499422d8834c07442fbb9f0c67a4722991");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("831ffd411139aa8e6ba72ed84d05473484be440300cfbdd12bce827d792bd19a");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("e225c59a2dab3f4eec1e15807f30c10e585776b654ce0e334bde44a8e65b2342");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("e2b6b013e6a8202c9ebc76ba8788bb3098393b3826e28ca40513cba8f0ae2947");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("509fd965048f2763928f6d00b679effb7e31cf83af7e8baa6618c718fb024dfc");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("2f65604be24705b4deef860e7a5fa5a42269bef1b5804c132cc8ae7c7d6f2ceb");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("f04636bb9d57f8d861f88cfaa18d12d50d9170c26c3f3d119c92dea1d470eeaf");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("a1a05f1a7861889d2fb94d2b30f710ad8d75136944cbe0d7c243e8afa58d6a47");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("744629263041f0eccfce4a1ebcc18c4c984010f9241d35966263a8b2f72ee26b");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("9e4009917f9759e6f21f5a588010f57e6d6eae178d8b20ab59cda66f42b15c6a");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("ce6e57f0140e5f606e404b5991f51679eee7626ad92dbd14ea0c2410a311c560");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("799ea038ca740a7cbab457a7404a5b90e9611e6b296ed4eeee710fb37b7834de");
    ...
    tmp.in_data =
        tc::cli::FormatUtil::hexStringToBytes("eb3365a0a9d141270334065547418fe64c47823c024082b94d54a66d149f2af1");
