...
class crypto_CmacTdes168Generator_TestClass : public ITestClass
{
  public:
    crypto_CmacTdes168Generator_TestClass();
  ...
  private:
    ...
    void util_Setup_TestCases(std::vector<crypto_CmacTdes168Generator_TestClass::TestCase> &test_cases);
};
