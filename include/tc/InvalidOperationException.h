...
class InvalidOperationException : public tc::Exception
{
  public:
    /// Default Constructor
    InvalidOperationException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    InvalidOperationException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    InvalidOperationException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what)
    {
    }
};
