...
class OutOfMemoryException : public tc::Exception
{
  public:
    /// Default Constructor
    OutOfMemoryException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    OutOfMemoryException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    OutOfMemoryException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what) {}
};
