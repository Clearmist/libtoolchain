 ...
 * @brief The exception that is thrown when the operating system denies access because of an I/O error or a specific
...
class UnauthorisedAccessException : public tc::Exception
{
  public:
    /// Default Constructor
    UnauthorisedAccessException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    UnauthorisedAccessException(const std::string &what) noexcept : tc::Exception(what) {}
