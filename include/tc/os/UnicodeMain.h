 ...
 *
 * You must define @ref umain() as your entry point if you include this header. Compiler errors will occur if you define
 *any other entrypoints or do not define @ref umain().
 **/
#include <string>
#include <vector>
#ifdef _WIN32
