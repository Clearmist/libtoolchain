...
class AccessViolationException : public tc::Exception
{
  public:
    /// Default Constructor
    AccessViolationException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    AccessViolationException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    AccessViolationException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what)
    {
    }
};
