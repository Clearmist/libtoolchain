 ...
 * @brief The exception that is thrown when the value of an argument is outside the allowable range of values as defined
...
class ArgumentOutOfRangeException : public tc::ArgumentException
{
  public:
    /// Default Constructor
    ArgumentOutOfRangeException() noexcept : tc::ArgumentException() {}
     ...
     * - error() == what
     **/
    ArgumentOutOfRangeException(const std::string &what) noexcept : tc::ArgumentException(what) {}
