...
class ArgumentException : public tc::Exception
{
  public:
    /// Default Constructor
    ArgumentException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    ArgumentException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    ArgumentException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what) {}
};
