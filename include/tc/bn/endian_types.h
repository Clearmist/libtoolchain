...
static inline void __local_bswap32(void *x)
{
    ...
    *((uint32_t *)x) =
        ((tmp << 24) & 0xff000000) | ((tmp << 8) & 0x00ff0000) | ((tmp >> 8) & 0x0000ff00) | ((tmp >> 24) & 0x000000ff);
}

static inline uint64_t __local_bswap64(uint64_t x)
{
    return (uint64_t)__local_bswap32(x >> 32) | ((uint64_t)__local_bswap32(x & 0xFFFFFFFF) << 32);
}
...
static inline uint64_t __be_uint64(uint64_t a)
{
    return __local_bswap64(a);
}
static inline uint32_t __be_uint32(uint32_t a)
{
    return __local_bswap32(a);
}
static inline uint16_t __be_uint16(uint16_t a)
{
    return __local_bswap16(a);
}
static inline uint64_t __le_uint64(uint64_t a)
{
    return a;
}
static inline uint32_t __le_uint32(uint32_t a)
{
    return a;
}
static inline uint16_t __le_uint16(uint16_t a)
{
    return a;
}

static inline void __be_swap64(void *a)
{
    __local_bswap64(a);
}
static inline void __be_swap32(void *a)
{
    __local_bswap32(a);
}
static inline void __be_swap16(void *a)
{
    __local_bswap16(a);
}
static inline void __le_swap64(void *a)
{
    return;
}
static inline void __le_swap32(void *a)
{
    return;
}
static inline void __le_swap16(void *a)
{
    return;
}
...
template <typename T> struct le16
{
  public:
    ...
    {
        T tmp = mVar;
        detail::__le_swap16(&tmp);
        return tmp;
    }
    /// Wrap value
    inline void wrap(const T &var)
    {
        mVar = var;
        detail::__le_swap16(&mVar);
    }
 ...
 **/
template <typename T> struct be16
{
  public:
 ...
 **/
template <typename T> struct le32
{
  public:
 ...
 **/
template <typename T> struct le64
{
  public:
 ...
 **/
template <typename T> struct be64
{
  public:
