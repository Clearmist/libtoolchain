 ...
 * @brief The exception that is thrown when an invoked method is not supported, or when there is an attempt to read,
...
class NotSupportedException : public tc::Exception
{
  public:
    /// Default Constructor
    NotSupportedException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    NotSupportedException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    NotSupportedException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what) {}
};
