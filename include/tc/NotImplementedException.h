...
class NotImplementedException : public tc::Exception
{
  public:
    /// Default Constructor
    NotImplementedException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    NotImplementedException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    NotImplementedException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what)
    {
    }
};
