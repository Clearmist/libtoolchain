...
class SecurityException : public tc::Exception
{
  public:
    /// Default Constructor
    SecurityException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    SecurityException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    SecurityException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what) {}
};
