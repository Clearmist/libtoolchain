...
class FormatUtil
{
  public:
     ...
     **/
    static std::string
    formatBytesAsString(const byte_t *data, size_t size, bool is_upper_case, const std::string &delimiter);
     ...
     * @return Formatted string
     **/
    static std::string formatBytesAsStringWithLineLimit(
        const byte_t *data,
        size_t size,
        bool is_upper_case,
        ...
        size_t row_len,
        size_t indent_len,
        bool print_first_indent = true);

    /**
     * @brief Format a list of strings as comma delimited. Introducing a new-line to keep each row within a certain
     *size.
     *
     ...
     * @return Formatted string
     **/
    static std::string formatListWithLineLimit(
        const std::vector<std::string> &str_list, size_t row_len, size_t indent_len, bool print_first_indent = true);
     ...
     **/
    static std::string
    formatBytesAsHxdHexString(const byte_t *data, size_t size, size_t bytes_per_row, size_t byte_group_size);
