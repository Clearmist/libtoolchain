...
template <class T> inline Optional<T>::Optional() : mValue() {}

template <class T> inline Optional<T>::Optional(const T &value) : Optional()
{
    *this = value;
}

template <class T> inline Optional<T>::Optional(const Optional<T> &other) : Optional()
{
    *this = other;
}

template <class T> inline void Optional<T>::operator=(const T &value)
{
...
template <class T> inline void Optional<T>::operator=(const Optional<T> &other)
{
...
template <class T> inline T &Optional<T>::get() const
{
    return *mValue;
}

template <class T> inline bool Optional<T>::isNull() const
{
    return mValue == nullptr;
}

template <class T> inline bool Optional<T>::isSet() const
{
    return mValue != nullptr;
}

template <class T> inline void Optional<T>::makeNull()
{
    mValue.reset();
}
