 ...
 * @brief The exception that is thrown when an arithmetic, casting, or conversion operation in a checked context results
 *in an overflow.
 **/
class OverflowException : public tc::ArithmeticException
{
  public:
    /// Default Constructor
    OverflowException() noexcept : tc::ArithmeticException() {}
     ...
     * - error() == what
     **/
    OverflowException(const std::string &what) noexcept : tc::ArithmeticException(what) {}
