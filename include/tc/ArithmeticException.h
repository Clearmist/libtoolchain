...
class ArithmeticException : public tc::Exception
{
  public:
    /// Default Constructor
    ArithmeticException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    ArithmeticException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    ArithmeticException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what) {}
};
