 ...
 *
 * @details
 * Counter (CTR) mode encrypts blocks of data independently (and uniquely) of each other, acting as a psuedo stream
 * cipher. Random access supported by CTR mode. Encryption and decryption operations are identical.
 *
 ...
 */
template <class BlockCipher> class CtrEncryptor
{
  public:
