...
/**
 * @typedef Rsa1024PssSha2512Signer
 ...
 */
using Rsa1024PssSha2512Signer = RsaPssSigner<1024, Sha2512Generator>;

/**
 * @typedef Rsa2048PssSha2512Signer
 ...
 * For more information refer to @ref RsaPssSigner.
 */
using Rsa2048PssSha2512Signer = RsaPssSigner<2048, Sha2512Generator>;

/**
 * @typedef Rsa4096PssSha2512Signer
 ...
 * For more information refer to @ref RsaPssSigner.
 */
using Rsa4096PssSha2512Signer = RsaPssSigner<4096, Sha2512Generator>;
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa1024PssSha2512Signer::kSignatureSize</tt>.
 *
 * @post
 ...
 */
bool SignRsa1024PssSha2512(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool VerifyRsa1024PssSha2512(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa2048PssSha2512Signer::kSignatureSize</tt>.
 *
 * @post
 * - The signature is written to <tt><var>signature</var></tt>.
 *
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool SignRsa2048PssSha2512(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool VerifyRsa2048PssSha2512(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa4096PssSha2512Signer::kSignatureSize</tt>.
 *
 * @post
 * - The signature is written to <tt><var>signature</var></tt>.
 *
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool SignRsa4096PssSha2512(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool VerifyRsa4096PssSha2512(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
