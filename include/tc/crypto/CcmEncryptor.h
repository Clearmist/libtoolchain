 ...
 *
 * @details
 * Counter with CBC-MAC (CCM) mode is an authenticated block cipher. It is designed to be used with small discrete
 * payloads, encrypted/decrypted in one go.
 *
 ...
 *   - When using @ref decrypt() you must compare the generated MAC with the expected one, alternatively you can use
 * @ref decrypt_and_verify()
 */
template <class BlockCipher> class CcmEncryptor
{
  public:
