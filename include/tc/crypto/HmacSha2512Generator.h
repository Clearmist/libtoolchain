 ...
 */
using HmacSha2512Generator = HmacGenerator<Sha2512Generator>;
 ...
 *
 * @pre
 * - Size of the MAC buffer must >= <tt>HmacSha2512Generator::kMacSize</tt>.
 *
 * @post
 ...
 * To calculate a MAC for data split into multiple arrays, use the @ref HmacSha2512Generator class.
 */
void GenerateHmacSha2512Mac(byte_t *mac, const byte_t *data, size_t data_size, const byte_t *key, size_t key_size);
