/**
 * @file RsaOaepSha2512Encryptor.h
...
/**
 * @typedef Rsa2048OaepSha2512Encryptor
 ...
 */
using Rsa2048OaepSha2512Encryptor = RsaOaepEncryptor<2048, Sha2512Generator>;

/**
 * @typedef Rsa4096OaepSha2512Encryptor
 ...
 * For more information refer to @ref RsaOaepEncryptor.
 */
using Rsa4096OaepSha2512Encryptor = RsaOaepEncryptor<4096, Sha2512Generator>;
 ...
 *
 * @pre
 * - Size of the @p block buffer must >= <tt>Rsa2048OaepSha2512Encryptor::kBlockSize</tt>.
 * - The maximum size for @p message_size is <tt>Rsa2048OaepSha2512Encryptor::kBlockSize</tt> - (2 *
 * <tt>Sha2512Generator::kHashSize</tt>) - 2
 *
 * @post
 ...
 * Rsa2048OaepSha2512Encryptor class directly.
 */
bool EncryptRsa2048OaepSha2512(
    byte_t *block,
 ...
 * @pre
 * - Size of the @p block buffer must >= <tt>Rsa2048OaepSha2512Encryptor::kBlockSize</tt>.
 * - @p message_capacity >= (<tt>Rsa2048OaepSha2512Encryptor::kBlockSize</tt> - (2 *
 * <tt>Sha2512Generator::kHashSize</tt>) - 2)
 *
 * @post
 ...
 */
bool DecryptRsa2048OaepSha2512(
    byte_t *message,
    size_t &message_size,
 ...
 *
 * @pre
 * - Size of the @p block buffer must >= <tt>Rsa4096OaepSha2512Encryptor::kBlockSize</tt>.
 * - The maximum size for @p message_size is <tt>Rsa4096OaepSha2512Encryptor::kBlockSize</tt> - (2 *
 * <tt>Sha2512Generator::kHashSize</tt>) - 2
 *
 * @post
 * - The encrypted block is written to <tt><var>block</var></tt>.
 ...
 * possible to specify a pre-digested label instead, in which case set @p isLabelDigested to true. OAEP encoding uses a
 * random seed, this function generates the seed internally. To manually specify the seed, please use the  @ref
 * Rsa4096OaepSha2512Encryptor class directly.
 */
bool EncryptRsa4096OaepSha2512(
    byte_t *block,
    const byte_t *message,
    size_t message_size,
    const RsaKey &key,
 ...
 * @pre
 * - Size of the @p block buffer must >= <tt>Rsa4096OaepSha2512Encryptor::kBlockSize</tt>.
 * - @p message_capacity >= (<tt>Rsa4096OaepSha2512Encryptor::kBlockSize</tt> - (2 *
 * <tt>Sha2512Generator::kHashSize</tt>) - 2)
 *
 * @post
 * - The decrypted message is written to <tt><var>message</var></tt>.
 ...
 * possible to specify a pre-digested label instead, in which case set @p isLabelDigested to true.
 */
bool DecryptRsa4096OaepSha2512(
    byte_t *message,
    size_t &message_size,
    size_t message_capacity,
    const byte_t *block,
