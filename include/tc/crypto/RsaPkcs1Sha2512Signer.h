...
/**
 * @typedef Rsa1024Pkcs1Sha2512Signer
 ...
 */
using Rsa1024Pkcs1Sha2512Signer = RsaPkcs1Signer<1024, Sha2512Generator>;

/**
 * @typedef Rsa2048Pkcs1Sha2512Signer
 ...
 * For more information refer to @ref RsaPkcs1Signer.
 */
using Rsa2048Pkcs1Sha2512Signer = RsaPkcs1Signer<2048, Sha2512Generator>;

/**
 * @typedef Rsa4096Pkcs1Sha2512Signer
 ...
 * For more information refer to @ref RsaPkcs1Signer.
 */
using Rsa4096Pkcs1Sha2512Signer = RsaPkcs1Signer<4096, Sha2512Generator>;
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa1024Pkcs1Sha2512Signer::kSignatureSize</tt>.
 *
 * @post
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool SignRsa1024Pkcs1Sha2512(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool VerifyRsa1024Pkcs1Sha2512(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa2048Pkcs1Sha2512Signer::kSignatureSize</tt>.
 *
 * @post
 * - The signature is written to <tt><var>signature</var></tt>.
 *
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool SignRsa2048Pkcs1Sha2512(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool VerifyRsa2048Pkcs1Sha2512(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa4096Pkcs1Sha2512Signer::kSignatureSize</tt>.
 *
 * @post
 * - The signature is written to <tt><var>signature</var></tt>.
 *
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool SignRsa4096Pkcs1Sha2512(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2512Generator class.
 */
bool VerifyRsa4096Pkcs1Sha2512(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
