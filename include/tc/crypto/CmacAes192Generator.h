/**
 * @file CmacAes192Generator.h
 * @brief Declarations for API resources for CMAC-AES-192 calculations.
 * @author Jack (jakcron)
 * @version 0.1
 * @date 2024/12/10
 **/
...
/**
 * @brief Utility function for calculating CMAC-AES-192.
 *
 ...
 *
 * @pre
 * - Size of the MAC buffer must >= <tt>CmacAes192Generator::kMacSize</tt>.
 * - @p key_size == <tt>CmacAes192Generator::kMacSize</tt>.
 *
 * @post
 ...
 * To calculate a MAC for data split into multiple arrays, use the @ref CmacAes192Generator class.
 */
void GenerateCmacAes192Mac(byte_t *mac, const byte_t *data, size_t data_size, const byte_t *key, size_t key_size);
