 ...
 */
template <class BlockCipher> class CcmModeImpl
{
  public:
    ...
    CcmModeImpl() : mState(None), mCipher() {}

    void initialize(const byte_t *key, size_t key_size)
    {
        if (key == nullptr)
        {
            throw tc::ArgumentNullException("CcmModeImpl::initialize()", "key was null.");
        }
        if (key_size != kKeySize)
        {
            throw tc::ArgumentOutOfRangeException("CcmModeImpl::initialize()", "key_size did not equal kKeySize.");
        }
        ...
        size_t tag_size)
    {
        ...
        if (dst == nullptr)
        {
            throw tc::ArgumentNullException("CcmModeImpl::encrypt()", "dst was null.");
        }
        if (src == nullptr)
        {
            throw tc::ArgumentNullException("CcmModeImpl::encrypt()", "src was null.");
        }
        if (size == 0)
        {
            throw tc::ArgumentOutOfRangeException("CcmModeImpl::encrypt()", "size was 0.");
        }
        if ((iv_size == 0) != (iv == nullptr))
        {
            throw tc::ArgumentNullException(
                "CcmModeImpl::encrypt()", "iv_size was non-zero, when iv was null. Or vice versa.");
        }
        if ((add_size == 0) != (add == nullptr))
        {
            throw tc::ArgumentNullException(
                "CcmModeImpl::encrypt()", "add_size was non-zero, when add was null. Or vice versa.");
        }
        if ((tag_size == 0) != (tag == nullptr))
        {
            throw tc::ArgumentNullException(
                "CcmModeImpl::encrypt()", "tag_size was non-zero, when iv was null. Or vice versa.");
        }
        ...
        size_t tag_size)
    {
        ...
        if (dst == nullptr)
        {
            throw tc::ArgumentNullException("CcmModeImpl::decrypt()", "dst was null.");
        }
        if (src == nullptr)
        {
            throw tc::ArgumentNullException("CcmModeImpl::decrypt()", "src was null.");
        }
        if (size == 0)
        {
            throw tc::ArgumentOutOfRangeException("CcmModeImpl::decrypt()", "size was 0.");
        }
        if ((iv_size == 0) != (iv == nullptr))
        {
            throw tc::ArgumentNullException(
                "CcmModeImpl::decrypt()", "iv_size was non-zero, when iv was null. Or vice versa.");
        }
        if ((add_size == 0) != (add == nullptr))
        {
            throw tc::ArgumentNullException(
                "CcmModeImpl::decrypt()", "add_size was non-zero, when add was null. Or vice versa.");
        }
        if ((tag_size == 0) != (tag == nullptr))
        {
            throw tc::ArgumentNullException(
                "CcmModeImpl::decrypt()", "tag_size was non-zero, when iv was null. Or vice versa.");
        }
  ...
  private:
    ...
    inline void create_tag_block0(
        byte_t *block, const byte_t *iv, size_t iv_size, size_t add_size, size_t tag_size, size_t payload_size)
    {
        /*
         * First block B_0:
         * 0         .. 0        flags
