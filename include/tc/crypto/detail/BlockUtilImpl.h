...
template <size_t BlockSize> inline void incr_counter(byte_t *counter, uint64_t incr)
{
...
template <> inline void incr_counter<16>(byte_t *counter, uint64_t incr)
{
...
template <size_t BlockSize> inline void xor_block(byte_t *dst, const byte_t *src_a, const byte_t *src_b)
{
...
template <> inline void xor_block<16>(byte_t *dst, const byte_t *src_a, const byte_t *src_b)
{
