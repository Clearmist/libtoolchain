...
class CryptoException : public tc::Exception
{
  public:
    /// Default Constructor
    CryptoException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    CryptoException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    CryptoException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what) {}
};
