 ...
 *
 * @details
 * XTS (<b>X</b>EX mode with cipher<b>t</b>ext <b>s</b>tealing) mode is designed for disk encryption, and as such
 * operates on sectors of data rather than blocks. Unlike XEX (<b>X</b>OR <b>e</b>ncrypt <b>X</b>OR) mode the sector
 * size does not have to be a multiple of the block size.
 *
 ...
 */
template <class BlockCipher> class XtsEncryptor
{
  public:
