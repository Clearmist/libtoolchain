...
/**
 * @typedef Rsa1024PssSha2256Signer
 ...
 */
using Rsa1024PssSha2256Signer = RsaPssSigner<1024, Sha2256Generator>;

/**
 * @typedef Rsa2048PssSha2256Signer
 ...
 * For more information refer to @ref RsaPssSigner.
 */
using Rsa2048PssSha2256Signer = RsaPssSigner<2048, Sha2256Generator>;

/**
 * @typedef Rsa4096PssSha2256Signer
 ...
 * For more information refer to @ref RsaPssSigner.
 */
using Rsa4096PssSha2256Signer = RsaPssSigner<4096, Sha2256Generator>;
 ...
 */
bool SignRsa1024PssSha2256(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2256Generator class.
 */
bool VerifyRsa1024PssSha2256(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa2048PssSha2256Signer::kSignatureSize</tt>.
 *
 * @post
 * - The signature is written to <tt><var>signature</var></tt>.
 *
 ...
 * To calculate a message digest use the @ref Sha2256Generator class.
 */
bool SignRsa2048PssSha2256(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2256Generator class.
 */
bool VerifyRsa2048PssSha2256(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 *
 * @pre
 * - Size of the signature buffer must >= <tt>Rsa4096PssSha2256Signer::kSignatureSize</tt>.
 *
 * @post
 * - The signature is written to <tt><var>signature</var></tt>.
 *
 ...
 * To calculate a message digest use the @ref Sha2256Generator class.
 */
bool SignRsa4096PssSha2256(byte_t *signature, const byte_t *message_digest, const RsaKey &key);
 ...
 * To calculate a message digest use the @ref Sha2256Generator class.
 */
bool VerifyRsa4096PssSha2256(const byte_t *signature, const byte_t *message_digest, const RsaKey &key);
