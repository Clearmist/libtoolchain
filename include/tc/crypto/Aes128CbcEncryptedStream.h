 ...
 * @details This class takes an encrypted IStream, encryption parameters and creates an IStream that will transparently
...
class Aes128CbcEncryptedStream : public tc::io::IStream
{
  public:
     ...
     * @post This will create an uninitialized Aes128CbcEncryptedStream, it will have to be assigned from a valid
     *Aes128CbcEncryptedStream object to be usable.
     **/
     ...
     * @param[in] iv      AES128-CBC Initilization vector relative to offset 0x0 of the base stream. See @ref
     *Aes128CbcEncryptedStream::iv_t.
     *
     ...
     * @note Exceptions thrown by the base stream are not altered/intercepted, refer to that module's documentation for
     *those exceptions.
     *
     ...
     *the number of bytes written. @ref write is not implemented for @ref Aes128CbcEncryptedStream.
    ...
    /**
     * @brief Clears all buffers for this and the base stream and causes any buffered data to be written to the
     *underlying device.
     *
