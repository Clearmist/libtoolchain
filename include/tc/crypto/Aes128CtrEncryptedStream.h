...
class Aes128CtrEncryptedStream : public tc::io::IStream
{
  public:
     ...
     * @post This will create an uninitialized Aes128CtrEncryptedStream, it will have to be assigned from a valid
     *Aes128CtrEncryptedStream object to be usable.
     **/
     ...
     *the number of bytes written. @ref write is not supported for @ref Aes128CtrEncryptedStream.
