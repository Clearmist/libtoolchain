...
class SubStream : public tc::io::IStream
{
  public:
     ...
     * @post This will create an unusable SubStream, it will have to be assigned from a valid SubStream object to be
     *usable.
     **/
    SubStream();
     ...
     * @throw tc::ArgumentOutOfRangeException @p offset or @p length is negative or otherwise invalid given the length
     *of the base stream.
     **/
