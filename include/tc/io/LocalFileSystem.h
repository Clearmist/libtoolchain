...
class LocalFileSystem : public tc::io::IFileSystem
{
  public:
     ...
     * @throw tc::io::PathTooLongException The specified path, file name, or both exceed the system-defined maximum
     *length.
    ...
    /**
     * @brief Open a file
     * @param[in] path A relative or absolute path for the file that the current @ref IFileSystem object will open an
     *@ref IStream for.
     ...
     *object. This also determines the values returned by the @ref IStream::canRead and @ref IStream::canWrite methods
     *of the IStream object. @ref IStream::canSeek is true if path specifies a disk file.
     ...
     * @throw tc::io::PathTooLongException The specified path, directory name, or both exceed the system-defined maximum
     length.
