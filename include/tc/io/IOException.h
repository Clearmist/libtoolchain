...
class IOException : public tc::Exception
{
  public:
    /// Default Constructor
    IOException() noexcept : tc::Exception() {}
     ...
     * - error() == what
     **/
    IOException(const std::string &what) noexcept : tc::Exception(what) {}
     ...
     * - error() == what
     **/
    IOException(const std::string &module, const std::string &what) noexcept : tc::Exception(module, what) {}
};
