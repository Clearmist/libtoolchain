 ...
 * @brief This is an extension for the IPathResolver interface that specifies additional methods for setting the current
 * directory. For more information see @ref tc::io::IPathResolver.
 */
