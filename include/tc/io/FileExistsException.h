...
class FileExistsException : public tc::io::IOException
{
  public:
    /// Default Constructor
    FileExistsException() noexcept : tc::io::IOException() {}
     ...
     * - error() == what
     **/
    FileExistsException(const std::string &what) noexcept : tc::io::IOException(what) {}
     ...
     * - error() == what
     **/
    FileExistsException(const std::string &module, const std::string &what) noexcept : tc::io::IOException(module, what)
    {
    }
};
