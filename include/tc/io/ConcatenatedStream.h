...
class ConcatenatedStream : public tc::io::IStream
{
  public:
     ...
     * @post This will create an unusable ConcatenatedStream, it will have to be assigned from a valid
     *ConcatenatedStream object to be usable.
     **/
    ConcatenatedStream();
  ...
  private:
    ...
    inline bool isStreamDisposed() const
    {
        return mStreamList.empty() || mCurrentStream.isNull() || mCurrentStream.get() == mStreamList.end();
    }
